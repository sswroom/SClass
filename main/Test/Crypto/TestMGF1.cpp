...
Int32 MyMain(NN<Core::ProgControl> progCtrl)
{
	...
	if (!Text::StrEqualsC(sbuff, (UIntOS)(sptr - sbuff), UTF8STRC("1AC907")))
	{
		return 1;
	}
	...
	if (!Text::StrEqualsC(sbuff, (UIntOS)(sptr - sbuff), UTF8STRC("1AC9075CD4")))
	{
		return 1;
	}
	...
	sptr = Text::StrHexBytes(sbuff, hashVal, 5, 0);
	if (!Text::StrEqualsC(sbuff, (UIntOS)(sptr - sbuff), UTF8STRC("BC0C655E01")))
	{
		return 1;
	}
	...
	if (!Text::StrEqualsC(sbuff, (UIntOS)(sptr - sbuff), UTF8STRC("BC0C655E016BC2931D85A2E675181ADCEF7F581F76DF2739DA74FAAC41627BE2F7F415C89E983FD0CE80CED9878641CB4876")))
	{
		return 1;
	}
	...
	sptr = Text::StrHexBytes(sbuff, hashVal, 50, 0);
	if (!Text::StrEqualsC(sbuff, (UIntOS)(sptr - sbuff), UTF8STRC("382576A7841021CC28FC4C0948753FB8312090CEA942EA4C4E735D10DC724B155F9F6069F289D61DACA0CB814502EF04EAE1")))
	{
		return 1;
	}
