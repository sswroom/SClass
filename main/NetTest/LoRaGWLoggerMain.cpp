...
void __stdcall OnMessage(AnyType userObj, Bool toServer, UInt8 ver, UInt16 token, UInt8 msgType, UnsafeArray<const UInt8> msg, UIntOS msgSize)
{
	NN<IO::LogTool> log = userObj.GetNN<IO::LogTool>();
	Text::StringBuilderUTF8 sb;
	Net::LoRaGWUtil::ParseGWMPMessage(sb, toServer, ver, token, msgType, Data::ByteArrayR(msg, msgSize));
