...
Int32 MyMain(Core::IProgControl *progCtrl)
{
	...
	console.WriteLine((const UTF8Char*)"Expected: 0c60c80f961f0e71f3a9b524af6012062fe037a6");
	console.WriteLine();

	Test(&console, "password", "salt", 2, 20);
	console.WriteLine((const UTF8Char*)"Expected: ea6c014dc72d6f8ccd1ed92ace1d41f0d8de8957");
	console.WriteLine();

	Test(&console, "password", "salt", 4096, 20);
	console.WriteLine((const UTF8Char*)"Expected: 4b007901b765489abead49d926f721d065a429c1");
	console.WriteLine();

	Test(&console, "password", "salt", 16777216, 20);
	console.WriteLine((const UTF8Char*)"Expected: eefe3d61cd4da4e4e9945b3d6ba2158c2634e984");
	console.WriteLine();

	Test(&console, "passwordPASSWORDpassword", "saltSALTsaltSALTsaltSALTsaltSALTsalt", 4096, 25);
	console.WriteLine((const UTF8Char*)"Expected: 3d2eec4fe41c849b80c8d83662c0e44a8b291a964cf2f07038");
	console.WriteLine();
	return 0;
}
