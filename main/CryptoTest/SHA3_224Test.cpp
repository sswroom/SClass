...
Int32 MyMain(Core::IProgControl *progCtrl)
{
	...
	console.WriteLineC(UTF8STRC("6b4e03423667dbb73b6e15454f0eb1abd4597f9a1b078e3f5b5a6bc7"));
	console.WriteLine();
	...
	sptr = Text::StrHexBytes(sbuff, hashVal, 28, 0);
	console.WriteLineC(sbuff, (UOSInt)(sptr - sbuff));
	console.WriteLineC(UTF8STRC("e642824c3f8cf24ad09234ee7d3c766fc9a3a5168d0c94ad73b46fdf"));
	console.WriteLine();
	...
	sptr = Text::StrHexBytes(sbuff, hashVal, 28, 0);
	console.WriteLineC(sbuff, (UOSInt)(sptr - sbuff));
	console.WriteLineC(UTF8STRC("8a24108b154ada21c9fd5574494479ba5c7e7ab76ef264ead0fcce33"));
