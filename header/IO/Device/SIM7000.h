...
namespace IO
{
	namespace Device
	{
		...
		public:
			...
			//AT+CIFSREX
			//AT+CIPSTATUS
			Bool NetGetDNSList(NN<Data::ArrayListNative<UInt32>> dnsList); //AT+CDNSCFG
			...
			Bool NetPing(UnsafeArray<const UTF8Char> addr, OutParam<UInt32> respTime, OutParam<UInt32> ttl);//AT+CIPPING
			//AT+CIPCTL
			//AT+CIPFLT
		};		
	}
