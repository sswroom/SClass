...
namespace IO
{
	namespace Device
	{
		...
		public:
			...
			Bool VoiceGetBaudRate(Int32 *baudRate);
			Bool VoiceSetBaudRate(Int32 baudRate);
			Bool VoiceGetCallerIDType(CallerIDType *callerIDType);
			Bool VoiceSetCallerIDType(CallerIDType callerIDType);
			Bool VoiceGetType(VoiceType *voiceType);
			Bool VoiceSetType(VoiceType voiceType);
			Bool VoiceGetBufferSize(Int32 *buffSize);
			Bool VoiceGetBitsPerSample(Int32 *bps);
			Bool VoiceSetBitsPerSample(Int32 bps);
			Bool VoiceGetToneDur(Int32 *durMS);
