...
namespace IO
{
	...
	public:
		...
		virtual Bool GetOutputName(UOSInt index, UnsafeArray<UTF8Char> nameBuff, UnsafeArray<UTF8Char> fileNameBuff) = 0;
		...
		virtual Bool SetParamStr(Optional<ParamData> aram, UOSInt index, UnsafeArrayOpt<const UTF8Char> val);
