...
namespace UI
{
	...
	public:
		...
		UIntOS GetDataFormats(NN<Data::ArrayListNative<UInt32>> dataTypes);
	...
	public:
		...
		static UnsafeArray<UTF8Char> GetFormatName(UInt32 fmtId, UnsafeArray<UTF8Char> sbuff, UIntOS buffSize);
	};
}
#endif
