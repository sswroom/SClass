...
namespace Text
{
	...
	public:
		...
		NotNullPtr<StringBuilderUTF8> Append(Text::StringBase<UTF8Char> *s);
		NotNullPtr<StringBuilderUTF8> Append(NotNullPtr<Text::String> s);
		...
		NotNullPtr<StringBuilderUTF8> AppendUTF16(const UTF16Char *s, UOSInt utf16Cnt);
		NotNullPtr<StringBuilderUTF8> AppendUTF16BE(const UInt8 *s, UOSInt utf16Cnt);
		NotNullPtr<StringBuilderUTF8> AppendUTF32(const UTF32Char *s);
		NotNullPtr<StringBuilderUTF8> AppendUTF32(const UTF32Char *s, UOSInt utf32Cnt);
		NotNullPtr<StringBuilderUTF8> AppendSlow(const UTF8Char *s);

		NotNullPtr<StringBuilderUTF8> AppendS(const UTF8Char *s, UOSInt maxLen);
		NotNullPtr<StringBuilderUTF8> AppendUTF8Char(UTF8Char c)
		{
			this->AllocLeng(1);
			this->v[this->leng] = c;
		...
		NotNullPtr<StringBuilderUTF8> AppendChar(UTF32Char c, UOSInt repCnt);

		NotNullPtr<StringBuilderUTF8> AppendNE(const UTF8Char *s, UOSInt charCnt)
		{
		...
		NotNullPtr<StringBuilderUTF8> AppendNE2(const UTF8Char *str1, UOSInt len1, const UTF8Char *str2, UOSInt len2)
		{
		...
		NotNullPtr<StringBuilderUTF8> AppendNE(Text::StringBase<UTF8Char> *s)
		{
		...
		NotNullPtr<StringBuilderUTF8> AppendC(const UTF8Char *s, UOSInt charCnt)
		{
			this->AllocLeng(charCnt);
			MemCopyNOShort(&this->v[this->leng], s, charCnt);
			this->leng += charCnt;
		...
		NotNullPtr<StringBuilderUTF8> AppendC2(const UTF8Char *str1, UOSInt len1, const UTF8Char *str2, UOSInt len2)
		{
			UOSInt tlen = len1 + len2;
			this->AllocLeng(tlen);
			UTF8Char *dptr = &this->v[this->leng];
		...
		NotNullPtr<StringBuilderUTF8> AppendP(const UTF8Char *str, const UTF8Char *strEnd)
		{
			return AppendC(str, (UOSInt)(strEnd - str));
		}

		NotNullPtr<StringBuilderUTF8> AppendI16(Int16 iVal)
		{
			this->AllocLeng(6);
		...
		NotNullPtr<StringBuilderUTF8> AppendU16(UInt16 iVal)
		{
			this->AllocLeng(5);
		...
		NotNullPtr<StringBuilderUTF8> AppendI32(Int32 iVal)
		{
			this->AllocLeng(11);
		...
		NotNullPtr<StringBuilderUTF8> AppendU32(UInt32 iVal)
		{
			this->AllocLeng(10);
		...
		NotNullPtr<StringBuilderUTF8> AppendI64(Int64 iVal)
		{
			this->AllocLeng(22);
		...
		NotNullPtr<StringBuilderUTF8> AppendU64(UInt64 iVal)
		{
			this->AllocLeng(20);
		...
		NotNullPtr<StringBuilderUTF8> AppendDouble(Double dVal)
		{
			this->AllocLeng(32);
		...
		NotNullPtr<StringBuilderUTF8> AppendDate(const Data::Date &d)
		{
			this->AllocLeng(10);
		...
		NotNullPtr<StringBuilderUTF8> AppendDateTime(NotNullPtr<Data::DateTime> dt)
		{
			this->AllocLeng(19);
		...
		NotNullPtr<StringBuilderUTF8> AppendUOSInt(UOSInt iVal)
		{
	#if _OSINT_SIZE == 64
			this->AllocLeng(22);
			this->leng = (UOSInt)(Text::StrUInt64(&this->v[this->leng], iVal) - this->v);
		...
		NotNullPtr<StringBuilderUTF8> AppendSB(NotNullPtr<Text::StringBuilderUTF8> sb)
		{
			return Append(sb.Ptr());
		}

		NotNullPtr<StringBuilderUTF8> AppendHex8(UInt8 iVal)
		{
			this->AllocLeng(2);
		...
		NotNullPtr<StringBuilderUTF8> AppendHex16(UInt16 iVal)
		{
			this->AllocLeng(4);
		...
		NotNullPtr<StringBuilderUTF8> AppendHex24(UInt32 iVal)
		{
			this->AllocLeng(6);
		...
		NotNullPtr<StringBuilderUTF8> AppendHex32(UInt32 iVal)
		{
			this->AllocLeng(8);
		...
		NotNullPtr<StringBuilderUTF8> AppendHex32V(UInt32 iVal)
		{
			this->AllocLeng(8);
		...
		NotNullPtr<StringBuilderUTF8> AppendHex64(UInt64 iVal)
		{
			this->AllocLeng(16);
		...
		NotNullPtr<StringBuilderUTF8> AppendHex64V(UInt64 iVal)
		{
			this->AllocLeng(16);
		...
		NotNullPtr<StringBuilderUTF8> AppendHexOS(UOSInt iVal)
		{
		#if _OSINT_SIZE == 64
		...
		NotNullPtr<StringBuilderUTF8> AppendHexBuff(const UInt8 *buff, UOSInt buffSize, UTF8Char seperator, Text::LineBreakType lineBreak)
		{
			if (buffSize == 0)
				return *this;
			UOSInt lbCnt;
		...
		NotNullPtr<StringBuilderUTF8> AppendHexBuff(const Data::ByteArrayR &buff, UTF8Char seperator, Text::LineBreakType lineBreak)
		{
			return AppendHexBuff(buff.GetPtr(), buff.GetSize(), seperator, lineBreak);
		}

		NotNullPtr<StringBuilderUTF8> AppendHex8LC(UInt8 iVal)
		{
			this->AllocLeng(2);
		...
		NotNullPtr<StringBuilderUTF8> AppendHex16LC(UInt16 iVal)
		{
			this->AllocLeng(4);
		...
		NotNullPtr<StringBuilderUTF8> AppendHex24LC(UInt32 iVal)
		{
			this->AllocLeng(6);
		...
		NotNullPtr<StringBuilderUTF8> AppendHex32LC(UInt32 iVal)
		{
			this->AllocLeng(8);
		...
		NotNullPtr<StringBuilderUTF8> AppendHex32VLC(UInt32 iVal)
		{
			this->AllocLeng(8);
		...
		NotNullPtr<StringBuilderUTF8> AppendHex64LC(UInt64 iVal)
		{
			this->AllocLeng(16);
		...
		NotNullPtr<StringBuilderUTF8> AppendHex64VLC(UInt64 iVal)
		{
			this->AllocLeng(16);
		...
		NotNullPtr<StringBuilderUTF8> AppendHexOSLC(UOSInt iVal)
		{
		#if _OSINT_SIZE == 64
		...
		NotNullPtr<StringBuilderUTF8> AppendHexBuffLC(const UInt8 *buff, UOSInt buffSize, UTF8Char seperator, Text::LineBreakType lineBreak)
		{
			if (buffSize == 0)
				return *this;
			UOSInt lbCnt;
		...
		NotNullPtr<StringBuilderUTF8> AppendLB(Text::LineBreakType lbt)
		{
			switch (lbt)
			{
		...
		NotNullPtr<StringBuilderUTF8> RemoveANSIEscapes();

		NotNullPtr<StringBuilderUTF8> SetSubstr(UOSInt index)
		{
			if (index >= this->leng)
			{
				this->leng = 0;
	...
	FORCEINLINE void SBAppendF32(NotNullPtr<Text::StringBuilderUTF8> sb, Single v)
	{
		sb->AppendDouble(v);
	}	

	FORCEINLINE void SBAppendF64(NotNullPtr<Text::StringBuilderUTF8> sb, Double v)
	{
		sb->AppendDouble(v);
	}	
}
