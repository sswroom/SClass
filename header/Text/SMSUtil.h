...
namespace Text
{
	...
	public:
		static IntOS ToGSMBytes(UnsafeArray<const UTF16Char> msg, UnsafeArray<UInt8> buff, OutParam<DCS> dcs, OutParam<UInt32> dataLen);
		static IntOS ToUCS2Bytes(UnsafeArray<const UTF16Char> msg, UnsafeArray<UInt8> buff);
