...
namespace Text
{
	...
	public:
		...
		static void WriteArrayUOSRange(NN<Text::StyledTextWriter> writer, NN<Data::ArrayList<UOSInt>> arr, UOSInt startIndex, UOSInt endIndex);
		static void WriteArray(NN<Text::StyledTextWriter> writer, NN<Data::ArrayListStringNN> arr);
		static void WriteArrayUOS(NN<Text::StyledTextWriter> writer, NN<Data::ArrayList<UOSInt>> arr);
