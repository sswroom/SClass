...
namespace Net
{
	...
	public:
		TCPServerController(Net::SocketFactory *sockf, IO::LogTool *log, UInt16 port, const UTF8Char *prefix, UOSInt maxBuffSize, TCPServerHandler *hdlr, UOSInt workerCnt, Int32 timeoutSec);
		~TCPServerController();
