...
namespace Net
{
	...
	public:
		SAMLIdpConfig(Text::CStringNN serviceDispName, Text::CStringNN entityId, Text::CStringNN signOnLocation, Text::CStringNN logoutLocation, Optional<Crypto::Cert::X509Cert> encryptionCert, Optional<Crypto::Cert::X509Cert> signingCert);
		~SAMLIdpConfig();

		NN<Text::String> GetServiceDispName() const { return this->serviceDispName; }
		NN<Text::String> GetEntityId() const { return this->entityId; }
