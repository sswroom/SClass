...
namespace Net
{
	namespace WebServer
	{
		...
		private:
			...
			static Bool __stdcall BTDetailPubFunc(Net::WebServer::IWebRequest *req, Net::WebServer::IWebResponse *resp, const UTF8Char *subReq, WebServiceHandler *svc);
			...
			static void AppendBTTable(Text::StringBuilderUTF *sb, Net::WebServer::IWebRequest *req, Data::ArrayList<IO::BTScanLog::ScanRecord2*> *entryList, Bool inRangeOnly);
