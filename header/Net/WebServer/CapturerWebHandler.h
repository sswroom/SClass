...
namespace Net
{
	namespace WebServer
	{
		...
		private:
			...
			static void AppendWiFiTable(Text::StringBuilderUTF8 *sb, Net::WebServer::IWebRequest *req, Data::ArrayList<Net::WiFiLogFile::LogFileEntry*> *entryList, const Data::Timestamp &scanTime);
