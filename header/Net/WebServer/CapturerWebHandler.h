...
namespace Net
{
	namespace WebServer
	{
		...
		private:
			...
			static void AppendBTTable(Text::StringBuilderUTF8 *sb, Net::WebServer::IWebRequest *req, const Data::ArrayList<IO::BTScanLog::ScanRecord3*> *entryList, Bool inRangeOnly);
