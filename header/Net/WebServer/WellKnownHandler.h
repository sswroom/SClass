...
namespace Net
{
	namespace WebServer
	{
		...
		private:
			static Bool __stdcall AddFunc(NotNullPtr<Net::WebServer::IWebRequest> req, NotNullPtr<Net::WebServer::IWebResponse> resp, Text::CStringNN subReq, WebServiceHandler *me);
		public:
			WellKnownHandler();
