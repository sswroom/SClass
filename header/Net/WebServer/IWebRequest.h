...
namespace Net
{
	namespace WebServer
	{
		...
		public:
			...
			Bool GetQueryValueI16(Text::CString name, OutParam<Int16> val);
			Bool GetQueryValueU16(Text::CString name, OutParam<UInt16> val);
			Bool GetQueryValueI32(Text::CString name, OutParam<Int32> val);
			Bool GetQueryValueU32(Text::CString name, OutParam<UInt32> val);
			Bool GetQueryValueI64(Text::CString name, OutParam<Int64> val);
			Bool GetQueryValueF64(Text::CString name, OutParam<Double> val);
			...
			Bool GetHTTPFormInt16(Text::CString name, OutParam<Int16> valOut);
			Bool GetHTTPFormUInt16(Text::CString name, OutParam<UInt16> valOut);
			Bool GetHTTPFormInt32(Text::CString name, OutParam<Int32> valOut);
			Bool GetHTTPFormUInt32(Text::CString name, OutParam<UInt32> valOut);
			Bool GetHTTPFormInt64(Text::CString name, OutParam<Int64> valOut);
			Bool GetHTTPFormUInt64(Text::CString name, OutParam<UInt64> valOut);
