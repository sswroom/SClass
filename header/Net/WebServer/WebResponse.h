#ifndef _SM_NET_WEBSERVER_WEBRESPONSE
#define _SM_NET_WEBSERVER_WEBRESPONSE
#include "AnyType.h"
...
namespace Net
{
	namespace WebServer
	{
		...
		class WebResponse : public IO::Stream
		{
		public:
			typedef void (CALLBACKFUNC SSEDisconnectHandler)(NN<Net::WebServer::WebResponse> resp, AnyType userObj);
		public:
			WebResponse(NN<Text::String> sourceName);
			WebResponse(Text::CStringNN sourceName);
			virtual ~WebResponse();
			...
			virtual Bool AddDefHeaders(NN<Net::WebServer::WebRequest> req) = 0;
