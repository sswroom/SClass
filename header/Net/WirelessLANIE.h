...
namespace Net
{
	...
	public:
		...
		static void GetWPSInfo(UnsafeArray<const UInt8> iebuff, UIntOS ieLen, OutParam<Optional<Text::String>> manuf, OutParam<Optional<Text::String>> model, OutParam<Optional<Text::String>> serialNum);
	};
}
#endif
