...
namespace Net
{
	...
	{
	public:
		typedef Bool (__stdcall *SNMPTrapHandler)(void *userObj, NotNullPtr<const Net::SocketUtil::AddressInfo> addr, UInt16 port, NotNullPtr<const Net::SNMPUtil::TrapInfo> trap, NotNullPtr<Data::ArrayList<Net::SNMPUtil::BindingItem*>> itemList); // return true = no need to release
	private:
		Net::UDPServer *svr;
