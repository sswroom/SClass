...
namespace Net
{
	...
	public:
		...
		static void GenStatJSON(Text::StringBuilderUTF8 *sb, const Data::Timestamp &ts, UInt32 rxnb, UInt32 rxok, UInt32 rwfw, Double ackr, UInt32 dwnb, UInt32 txnb);
		static void GenStatJSON(Text::StringBuilderUTF8 *sb, const Data::Timestamp &ts, UInt32 rxnb, UInt32 rxok, UInt32 rwfw, Double ackr, UInt32 dwnb, UInt32 txnb, Double lat, Double lon, Int32 altitude);
	};
}
#endif