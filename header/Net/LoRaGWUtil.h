...
namespace Net
{
	...
	public:
		...
		static UOSInt GenUpPayload(UnsafeArray<UInt8> buff, Bool needConfirm, UInt32 devAddr, UInt32 fCnt, UInt8 fPort, UnsafeArray<const UInt8> nwkSKey, UnsafeArray<const UInt8> appSKey, UnsafeArray<const UInt8> payload, UOSInt payloadLen);
		static void GenRxpkJSON(NN<Text::StringBuilderUTF8> sb, UInt32 freq, UInt32 chan, UInt32 rfch, UInt32 codrk, Int32 rssi, Int32 lsnr, UnsafeArray<const UInt8> data, UOSInt dataSize);
