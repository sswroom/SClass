...
namespace Net
{
	...
	public:
		...
		static void AddBDAddr(IO::FileAnalyse::FrameDetailHandler *frame, UInt32 frameOfst, Text::CStringNN name, const UInt8 *mac, Bool randomAddr);
		...
		static void AddAddrType(IO::FileAnalyse::FrameDetailHandler *frame, UInt32 frameOfst, Text::CStringNN name, UInt8 addrType);
		...
		static void AddPHYType(IO::FileAnalyse::FrameDetailHandler *frame, UInt32 frameOfst, Text::CStringNN name, UInt8 phyType);
