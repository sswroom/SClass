...
namespace Net
{
	...
	public:
		...
		Bool ChannelTryRead(NN<SSHChannelHandle> channel, UnsafeArray<UInt8> buff, UIntOS maxSize, OutParam<UIntOS> size);
		UIntOS ChannelWrite(NN<SSHChannelHandle> channel, UnsafeArray<const UInt8> buff, UIntOS size);
