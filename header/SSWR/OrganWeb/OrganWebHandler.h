...
namespace SSWR
{
	namespace OrganWeb
	{
		...
		private:
			...
			static Bool __stdcall OnSessionDel(NotNullPtr<Net::WebServer::IWebSession> sess, void *userObj);
			static Bool __stdcall OnSessionCheck(NotNullPtr<Net::WebServer::IWebSession> sess, void *userObj);
