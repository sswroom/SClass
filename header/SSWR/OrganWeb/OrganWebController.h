...
namespace SSWR
{
	namespace OrganWeb
	{
		...
		protected:
			...
			static void ResponseMstm(NotNullPtr<Net::WebServer::IWebRequest> req, NotNullPtr<Net::WebServer::IWebResponse> resp, IO::MemoryStream *mstm, Text::CString contType);
