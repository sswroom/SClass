...
namespace SSWR
{
	namespace AVIRead
	{
		namespace MIMEViewer
		{
			...
			public:
				AVIRMIMEHTMLViewer(SSWR::AVIRead::AVIRCore *core, NotNullPtr<UI::GUICore> ui, UI::GUIClientControl *ctrl, Media::ColorManagerSess *sess, Text::MIMEObj::UnknownMIMEObj *obj);
