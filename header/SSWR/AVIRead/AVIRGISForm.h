...
namespace SSWR
{
	namespace AVIRead
	{
		...
		public:
			AVIRGISForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, NotNullPtr<SSWR::AVIRead::AVIRCore> core, NotNullPtr<Map::MapEnv> env, NotNullPtr<Map::MapView> view);
			virtual ~AVIRGISForm();
