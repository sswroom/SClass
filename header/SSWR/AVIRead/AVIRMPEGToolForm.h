#ifndef _SM_SSWR_AVIREAD_AVIRMPEGTOOLFORM
#define _SM_SSWR_AVIREAD_AVIRMPEGTOOLFORM
#include "Media/FileAnalyse/IFileAnalyse.h"
...
namespace SSWR
{
	namespace AVIRead
	{
		class AVIRMPEGToolForm : public UI::GUIForm
		{
		private:
			UI::GUIPanel *pnlCtrl;
			UI::GUILabel *lblFile;
		...
		public:
			AVIRMPEGToolForm(void *hInst, UI::GUIClientControl *parent, UI::GUIUI *ui, SSWR::AVIRead::AVIRCore *core);
			virtual ~AVIRMPEGToolForm();
