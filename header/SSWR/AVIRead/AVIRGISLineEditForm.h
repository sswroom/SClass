...
namespace SSWR
{
	namespace AVIRead
	{
		...
		private:
			...
			static void __stdcall OnThickScrolled(void *userObj, OSInt newPos);
			static Bool __stdcall ColorClicked(void *userObj, OSInt x, OSInt y, UI::GUIControl::MouseButton btn);
