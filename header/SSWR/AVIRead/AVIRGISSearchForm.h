...
//			System::Void txtSearchStr_KeyPress(System::Object *  sender, System::Windows::Forms::KeyPressEventArgs *  e);
		...
		public:
			AVIRGISSearchForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, NotNullPtr<SSWR::AVIRead::AVIRCore> core, IMapNavigator *navi, NotNullPtr<Map::MapDrawLayer> layer, Text::SearchIndexer *searching, UOSInt strIndex, Int32 flags);
