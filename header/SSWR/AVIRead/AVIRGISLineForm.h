...
namespace SSWR
{
	namespace AVIRead
	{
		...
		private:
			...
			static void __stdcall OnThickChanged(AnyType userObj, UIntOS newPos);
			static UI::EventState __stdcall OnColorDown(AnyType userObj, Math::Coord2D<IntOS> scnPos, MouseButton btn);
