...
namespace SSWR
{
	namespace AVIRead
	{
		...
		private:
			...
			void ParseSess16(NN<Manage::DasmX86_16::Session> sess, NN<Data::ArrayListStringNN> codes, NN<Data::ArrayListNN<ExeB16Addr>> parts, NN<Data::ArrayListInt32> partIndex, NN<ExeB16Addr> startAddr, NN<Manage::DasmX86_16> dasm, UIntOS codeSize);
			void InitSess16();
