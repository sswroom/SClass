...
namespace SSWR
{
	namespace AVIRead
	{
		...
		public:
			...
			Bool GenFontPreview(Media::DrawImage *img, Media::DrawEngine *eng, const UTF8Char *fontName, UOSInt nameLen, Double fontSizePt, UInt32 fontColor, Media::ColorConv *colorConv);
