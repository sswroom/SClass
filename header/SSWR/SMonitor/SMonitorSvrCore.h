...
namespace SSWR
{
	namespace SMonitor
	{
		...
		private:
			...
			static void __stdcall OnNotifyUDPPacket(NN<const Net::SocketUtil::AddressInfo> addr, UInt16 port, Data::ByteArrayR data, AnyType userData);
		...
		public:
			...
			Bool DeviceRecvReading(NN<DeviceInfo> dev, Int64 cliTime, UIntOS nDigitals, UIntOS nReading, UIntOS nOutput, UInt32 digitalVals, ReadingInfo *readings, Int32 profileId, UInt32 cliIP, UInt16 port);
			...
			virtual UIntOS DeviceQueryRec(Int64 cliId, Int64 startTime, Int64 endTime, NN<Data::ArrayListNN<DevRecord2>> recList);
			...
			virtual UIntOS UserGetDevices(Int32 userId, Int32 userType, NN<Data::ArrayListNN<DeviceInfo>> devList);
			virtual Bool UserHasDevice(Int32 userId, Int32 userType, Int64 cliId);
			virtual UIntOS UserGetList(NN<Data::ArrayListNN<WebUser>> userList);
			...
			void UserAgentLog(UnsafeArray<const UTF8Char> userAgent, UIntOS len);
			void UserAgentStore();
			
			void RefererLog(UnsafeArray<const UTF8Char> referer, UIntOS len);
			void RefererStore();
		};
	}
}
