...
namespace SSWR
{
	namespace SMonitor
	{
		...
		public:
			...
			virtual UIntOS GetMinInterval() = 0;
			virtual UIntOS GetReadingCnt() = 0;
			virtual ReadingType GetReadingType(UIntOS index) = 0;
			virtual Bool GetReadings(UnsafeArray<Double> values) = 0;
