...
namespace Media
{
	...
	public:
		...
		void SetParameter(Double brightness, Double contrast, Double gamma, NotNullPtr<const Media::ColorProfile> color, UInt32 bpp, Media::PixelFormat pf, UInt32 hdrLev);
