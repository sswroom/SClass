...
namespace Media
{
	...
	public:
		...
		void GenRGB8_LRGB(UnsafeArray<UInt16> rgbTable, NN<const Media::ColorProfile> srcProfile, Int32 nBitLRGB); //1536 bytes (RGB x 512)
		void GenRGBA8_LRGBC(UnsafeArray<Int64> rgbTable, NN<const Media::ColorProfile> srcProfile, NN<const Media::ColorProfile::ColorPrimaries> destPrimaries, Int32 nBitLRGB); //8192 bytes (rgba x 2048)
		...
		void GenLRGB_RGB16(UnsafeArray<UInt8> rgbTable, NN<const Media::ColorProfile> destProfile, Int32 nBitLRGB, Double srcRefLuminance); //65536 x 6 bytes
		void GenLRGB_A2B10G10R10(UnsafeArray<UInt8> rgbTable, NN<const Media::ColorProfile> destProfile, Int32 nBitLRGB, Double srcRefLuminance); //65536 x 12 bytes
		void GenLARGB_A2B10G10R10(UnsafeArray<UInt8> rgbTable, NN<const Media::ColorProfile> destProfile, Int32 nBitLRGB, Double srcRefLuminance); //65536 x 16 bytes
		void GenLARGB_B8G8R8A8(UnsafeArray<UInt8> rgbTable, NN<const Media::ColorProfile> destProfile, Int32 nBitLRGB, Double srcRefLuminance); //65536 x 16 bytes
		void GenW8_L(UnsafeArray<UInt16> rgbTable, NN<const Media::CS::TransferParam> srcTran, Int32 nBitLRGB); //512 (256 x 2) bytes
