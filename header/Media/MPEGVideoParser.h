...
namespace Media
{
	...
	public:
		static Bool GetFrameInfo(UInt8 *frame, UOSInt frameSize, Media::FrameInfo *frameInfo, Int32 *frameRateNorm, Int32 *frameRateDenorm, Int64 *bitRate, Bool decoderFix);
