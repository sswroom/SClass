...
namespace Media
{
	...
	public:
		static Bool GetFrameInfo(UInt8 *frame, UOSInt frameSize, NN<Media::FrameInfo> frameInfo, OutParam<UInt32> frameRateNorm, OutParam<UInt32> frameRateDenorm, UInt64 *bitRate, Bool decoderFix);
