...
namespace Media
{
	...
	public:
		...
		Bool DrawFromSurface(Media::MonitorSurface* surface, Bool waitForVBlank) { return this->DrawFromSurface(surface, Math::Coord2D<OSInt>(0, 0), surface->info.dispSize, false, waitForVBlank); };
		virtual Bool DrawFromSurface(Media::MonitorSurface* surface, Math::Coord2D<OSInt> destTL, Math::Size2D<UOSInt> buffSize, Bool clearScn, Bool waitForVBlank) = 0;
