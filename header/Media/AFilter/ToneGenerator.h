#ifndef _SM_MEDIA_AFILTER_TONEGENERATOR
#define _SM_MEDIA_AFILTER_TONEGENERATOR
...
namespace Media
{
	namespace AFilter
	{
		class ToneGenerator : public AudioFilter
		{
		public:
			typedef enum
			{
		...
		public:
			ToneGenerator(NN<AudioSource> sourceAudio);
