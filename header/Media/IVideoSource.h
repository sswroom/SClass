...
namespace Media
{
	...
	public:
		...
		typedef Bool (__stdcall *FrameInfoCallback)(UInt32 frameTime, OSInt frameNum, UOSInt dataSize, Media::IVideoSource::FrameStruct frameStruct, Media::FrameType frameType, void *userData, Media::YCOffset ycOfst); //return true to continue
		...
		virtual void SetBorderCrop(OSInt cropLeft, OSInt cropTop, OSInt cropRight, OSInt cropBottom) = 0;
		virtual void GetBorderCrop(OSInt *cropLeft, OSInt *cropTop, OSInt *cropRight, OSInt *cropBottom) = 0;
