...
namespace Media
{
	namespace CS
	{
		...
		public:
			...
			void Set(TransferType tranType, Double *params, UIntOS paramCnt);
			...
			Optional<Media::LUT> GetLUT() { return this->lut; }
			Optional<const Media::LUT> GetLUTRead() const { return this->lut; }
