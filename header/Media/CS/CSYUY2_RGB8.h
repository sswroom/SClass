#ifndef _SM_MEDIA_CS_CSYUY2_RGB8
#define _SM_MEDIA_CS_CSYUY2_RGB8
...
namespace Media
{
	namespace CS
	{
		class CSYUY2_RGB8 : public Media::CS::CSYUV_RGB8
		{
		private:
			typedef struct
			{
		...
		public:
			CSYUY2_RGB8(NotNullPtr<const Media::ColorProfile> srcColor, NotNullPtr<const Media::ColorProfile> destColor, Media::ColorProfile::YUVType yuvType, Media::ColorManagerSess *colorSess);
			virtual ~CSYUY2_RGB8();
