...
namespace Media
{
	namespace CS
	{
		...
		private:
			void UpdateRGBTable();
		public:
			CSRGB8_LRGBC(UOSInt srcNBits, Media::PixelFormat srcPF, Bool invert, NN<const Media::ColorProfile> srcProfile, NN<const Media::ColorProfile> destProfile, Media::ColorManagerSess *colorSess);
