...
namespace Media
{
	...
	public:
		...
		virtual Optional<MonitorHandle> GetMonitorHandle(UIntOS monIndex) = 0;
		virtual UIntOS GetMonitorCount() = 0;

		virtual Optional<MonitorSurface> CreateSurface(Math::Size2D<UIntOS> size, UIntOS bitDepth) = 0;
