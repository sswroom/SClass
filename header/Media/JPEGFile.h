...
namespace Media
{
	...
	{
	public:
		static Bool ParseJPEGHeader(NN<IO::StreamData> fd, NN<Media::RasterImage> img, NN<Media::ImageList> imgList, Optional<Parser::ParserList> parsers);
		...
		static void WriteJPGBuffer(NN<IO::Stream> stm, const UInt8 *jpgBuff, UIntOS buffSize, Optional<Media::RasterImage> oriImg);
	};
}
#endif
