...
namespace Media
{
	...
	{
	public:
		static Bool ParseJPEGHeader(NN<IO::StreamData> fd, Media::RasterImage *img, NN<Media::ImageList> imgList, Parser::ParserList *parsers);
		...
		static void WriteJPGBuffer(NN<IO::Stream> stm, const UInt8 *jpgBuff, UOSInt buffSize, Media::RasterImage *oriImg);
	};
}
#endif
