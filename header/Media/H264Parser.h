...
namespace Media
{
	...
	public:
		...
		static Bool FindSPS(UnsafeArray<const UInt8> frame, UOSInt frameSize, const UInt8 **sps, UOSInt *spsSize);
		static Bool FindPPS(UnsafeArray<const UInt8> frame, UOSInt frameSize, const UInt8 **pps, UOSInt *ppsSize);
