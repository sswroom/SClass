#ifndef _SM_MEDIA_COLORHANDLER
#define _SM_MEDIA_COLORHANDLER
#include "MyMemory.h"
...
namespace Media
{
	...
	public:
		virtual void YUVParamChanged(NN<const Media::ColorHandler::YUVPARAM> yuvParam) = 0;
		virtual void RGBParamChanged(NN<const Media::ColorHandler::RGBPARAM2> rgbParam) = 0;
	};
}
#endif
