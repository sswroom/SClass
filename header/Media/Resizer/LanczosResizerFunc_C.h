...
extern "C"
{
	...
	void LanczosResizerFunc_HorizontalFilterB16G16R16(const UInt8 *inPt, UInt8 *outPt,UOSInt width, UOSInt height, UOSInt tap, OSInt *index, Int64 *weight, OSInt sstep, OSInt dstep, UInt8 *rgba16Table, UOSInt swidth, UInt8 *tmpbuff);
	...
	void LanczosResizerFunc_ExpandB16G16R16(const UInt8 *inPt, UInt8 *outPt, UOSInt width, UOSInt height, OSInt sstep, OSInt dstep, UInt8 *rgba16Table);
	...
	void LanczosResizerFunc_ImgCopyB16G16R16_B8G8R8A8(const UInt8 *inPt, UInt8 *outPt, UOSInt width, UOSInt height, OSInt sstep, OSInt dstep, UInt8 *lrbgraTable, UInt8 *rgba16Table);
	...
	void LanczosResizerFunc_ImgCopyB16G16R16_B8G8R8(const UInt8 *inPt, UInt8 *outPt, UOSInt width, UOSInt height, OSInt sstep, OSInt dstep, UInt8 *lrbgraTable, UInt8 *rgba16Table);
}
