...
namespace Crypto
{
	namespace Hash
	{
		...
		public:
			...
			Bool GenHash(Text::StringBuilderUTF *sb, UInt32 cost, const UTF8Char *password, UOSInt pwdLen);
			Bool GenHash(Text::StringBuilderUTF *sb, UInt32 cost, const UInt8 *salt, const UTF8Char *password, UOSInt pwdLen);
		};
	}
}
#endif
