#ifndef _SM_MAP_MAPLAYERCFG
#define _SM_MAP_MAPLAYERCFG
...
namespace Map
{
	class MapLayerCfg : public Map::IMapConfig
	{
	public:
		typedef struct
		{
	...
	private:
		...
		static Int32 ToColor(const WChar *str);
		static Map::IMapDrawLayer *GetDrawLayer(const WChar *name, Data::ArrayList<Map::IMapDrawLayer*> *layerList);
		...
		static Bool AddLabel(MapLabels *labels, Int32 maxLabel, Int32 *labelCnt, const WChar *label, Int32 nPoints, Int32 *points, Int32 priority, Int32 recType, Int32 fntStyle, Int32 flag, Map::MapView *view);
	...
	public:
		MapLayerCfg(WChar *fileName, Media::DrawEngine *eng, Data::ArrayList<Map::IMapDrawLayer*> *layerList, Parser::ParserList *parserList, WChar *forceBase);
		virtual ~MapLayerCfg();

		virtual Bool IsError();
		Media::DrawPen *CreatePen(Media::DrawImage *img, Int32 lineStyle, Int32 lineLayer);
		virtual void DrawMap(Media::DrawImage *img, Map::MapView *view, Bool *isLayerEmpty, Map::MapScheduler *mapSch);
