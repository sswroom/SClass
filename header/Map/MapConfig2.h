...
namespace Map
{
	...
	private:
		...
		static Bool AddLabel(MapLabels2 *labels, UInt32 maxLabel, UInt32 *labelCnt, const UTF8Char *label, UInt32 nPoints, Double *points, Int32 priority, Int32 recType, UInt32 fntStyle, UInt32 flags, Map::MapView *view, Double xOfst, Double yOfst);
	...
	public:
		MapConfig2(Text::CString fileName, Media::DrawEngine *eng, Data::ArrayList<Map::IMapDrawLayer*> *layerList, Parser::ParserList *parserList, const UTF8Char *forceBase, IO::Writer *errWriter, Int32 maxScale, Int32 minScale);
		~MapConfig2();
