...
namespace Map
{
	...
	private:
		...
		static Bool DrawLinearRing(NotNullPtr<Math::Geometry::LinearRing> pg, NotNullPtr<Media::DrawImage> img, NotNullPtr<Map::MapView> view, Optional<Media::DrawBrush> b, Optional<Media::DrawPen> p, Math::Coord2DDbl ofst);
