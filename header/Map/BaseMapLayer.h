...
namespace Map
{
	...
	public:
		...
		static Map::MapDrawLayer *CreateLayer(BaseLayerType blt, NotNullPtr<Net::SocketFactory> sockf, Optional<Net::SSLEngine> ssl, NotNullPtr<Parser::ParserList> parsers);
	};
}
#endif
