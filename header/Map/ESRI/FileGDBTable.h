...
namespace Map
{
	namespace ESRI
	{
		...
		public:
			...
			DB::DBReader *OpenReader(Data::ArrayList<const UTF8Char*> *columnNames, UOSInt dataOfst, UOSInt maxCnt, const UTF8Char *ordering, Data::QueryConditions *conditions);	
		};
	}
}
#endif
