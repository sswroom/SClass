...
namespace Map
{
	...
	private:
		...
		const UTF8Char **CopyStrs(NN<Data::ArrayListStringNN> strs);
		void UpdateMapRate();
	public:
		VectorLayer(Map::DrawLayerType layerType, NN<Text::String> sourceName, UOSInt strCnt, const UTF8Char **colNames, NN<Math::CoordinateSystem> csys, UOSInt nameCol, Text::String *layerName);
		VectorLayer(Map::DrawLayerType layerType, Text::CStringNN sourceName, UOSInt strCnt, const UTF8Char **colNames, NN<Math::CoordinateSystem> csys, UOSInt nameCol, Text::CString layerName);
		VectorLayer(Map::DrawLayerType layerType, NN<Text::String> sourceName, UOSInt strCnt, const UTF8Char **colNames, NN<Math::CoordinateSystem> csys, DB::DBUtil::ColType *colTypes, UOSInt *colSize, UOSInt *colDP, UOSInt nameCol, Text::String *layerName);
		VectorLayer(Map::DrawLayerType layerType, Text::CStringNN sourceName, UOSInt strCnt, const UTF8Char **colNames, NN<Math::CoordinateSystem> csys, DB::DBUtil::ColType *colTypes, UOSInt *colSize, UOSInt *colDP, UOSInt nameCol, Text::CString layerName);
		...
		Bool AddVector(NN<Math::Geometry::Vector2D> vec, const UTF8Char **strs);
