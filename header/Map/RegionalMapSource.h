...
namespace Map
{
	...
	public:
		...
		static Map::MapDrawLayer *OpenMap(const MapInfo *map, NotNullPtr<Net::SocketFactory> sockf, Net::SSLEngine *ssl, Text::EncodingFactory *encFact, NotNullPtr<Parser::ParserList> parsers, Net::WebBrowser *browser);
	};
}
#endif
