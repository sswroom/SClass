...
namespace Math
{
	...
	public:
		...
		UIntOS CalcIntersactsAtY(UnsafeArray<Double> xArr, Double y) const;
		static Double Sign(Coord2DDbl p1, Coord2DDbl p2, Coord2DDbl p3);
		static Quadrilateral FromPolygon(UnsafeArray<Coord2D<UIntOS>> pg);
		static Quadrilateral FromPolygon(UnsafeArray<Coord2DDbl> pg);

	private:
		static UIntOS CalcIntersactAtY(Math::Coord2DDbl p1, Coord2DDbl p2, Double y, UnsafeArray<Double> xArr);
	};
}
#endif
