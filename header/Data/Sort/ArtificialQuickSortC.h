...
extern "C"
{
	...
	void ArtificialQuickSort_PreSortCmp(void **arr, Data::IComparable::CompareFunc func, OSInt firstIndex, OSInt lastIndex);
	...
	void ArtificialQuickSort_PreSortCmpInv(void **arr, Data::IComparable::CompareFunc func, OSInt firstIndex, OSInt lastIndex);
	...
	void ArtificialQuickSort_SortCmp(void **arr, Data::IComparable::CompareFunc func, OSInt firstIndex, OSInt lastIndex);
	...
	void ArtificialQuickSort_SortCmpInv(void **arr, Data::IComparable::CompareFunc func, OSInt firstIndex, OSInt lastIndex);
