...
namespace DB
{
	...
	{
	private:
		static Text::String *AppendFieldAnno(Text::StringBuilderUTF8 *sb, DB::ColDef *col); //return colName, need release
		static void AppendFieldDef(Text::StringBuilderUTF8 *sb, DB::ColDef *col, Text::String *colName);
