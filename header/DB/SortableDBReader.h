...
namespace DB
{
	...
	public:
		SortableDBReader(DB::ReadingDB *db, Text::CString tableName, Data::ArrayList<Text::String*> *colNames, UOSInt dataOfst, UOSInt maxCnt, Text::CString ordering, Data::QueryConditions *condition);
