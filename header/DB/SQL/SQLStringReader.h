#ifndef _SM_DB_SQLSTRINGREADER
#define _SM_DB_SQLSTRINGREADER
...
namespace DB
{
	namespace SQL
	{
		class SQLStringReader : public SQLEngineReader
		{
		private:
			...
			UIntOS currRow;
		public:
			SQLStringReader(NN<Data::ArrayListStringNN> colNames, NN<Data::ArrayListObj<Optional<Text::String>>> values);
			virtual ~SQLStringReader();
