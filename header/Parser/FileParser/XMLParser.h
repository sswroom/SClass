...
namespace Parser
{
	namespace FileParser
	{
		...
		public:
			...
			static IO::ParsedObject *ParseStream(Optional<Text::EncodingFactory> encFact, NN<IO::Stream> stm, Text::CStringNN fileName, Optional<Parser::ParserList> parsers, Optional<Net::WebBrowser> browser, IO::PackageFile *pkgFile);
		private:
