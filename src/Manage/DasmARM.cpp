...
UTF8Char *DasmARM_ParseReg32(Manage::DasmARM::DasmARM_Sess* sess, UTF8Char *regName, Int32 regNo, UInt32 **regPtr)
{
	...
	case 0:
		*regPtr = &sess->regs.R0;
		return Text::StrConcat(regName, (const UTF8Char*)"r0");
	case 1:
		*regPtr = &sess->regs.R1;
		return Text::StrConcat(regName, (const UTF8Char*)"r1");
	case 2:
		*regPtr = &sess->regs.R2;
		return Text::StrConcat(regName, (const UTF8Char*)"r2");
	case 3:
		*regPtr = &sess->regs.R3;
		return Text::StrConcat(regName, (const UTF8Char*)"r3");
	case 4:
		*regPtr = &sess->regs.R4;
		return Text::StrConcat(regName, (const UTF8Char*)"r4");
	case 5:
		*regPtr = &sess->regs.R5;
		return Text::StrConcat(regName, (const UTF8Char*)"r5");
	case 6:
		*regPtr = &sess->regs.R6;
		return Text::StrConcat(regName, (const UTF8Char*)"r6");
	case 7:
		*regPtr = &sess->regs.R7;
		return Text::StrConcat(regName, (const UTF8Char*)"r7");
	case 8:
		*regPtr = &sess->regs.R8;
	...
	case 14:
		*regPtr = &sess->regs.LR;
		return Text::StrConcat(regName, (const UTF8Char*)"lr");
	case 15:
		*regPtr = &sess->regs.PC;
		return Text::StrConcat(regName, (const UTF8Char*)"pc");
	default:
		*regName = 0;
		return regName;
	}
...
const UTF8Char *Manage::DasmARM::GetHeader(Bool fullRegs)
{
	if (fullRegs)
	{
...
Bool Manage::DasmARM::Disasm32(IO::IWriter *writer, Manage::AddressResolver *addrResol, UInt32 *currInst, UInt32 *currStack, UInt32 *currFrame, Data::ArrayListInt32 *callAddrs, Data::ArrayListInt32 *jmpAddrs, UInt32 *blockStart, UInt32 *blockEnd, Manage::Dasm::Dasm_Regs *regs, Manage::IMemoryReader *memReader, Bool fullRegs)
{
	UTF8Char sbuff[512];
	UInt8 buff[16];
	UInt32 oriPC;
...
Manage::Dasm::Dasm_Regs *Manage::DasmARM::CreateRegs()
{
	Manage::DasmARM::DasmARM_Regs *regs = MemAlloc(Manage::DasmARM::DasmARM_Regs, 1);
	return regs;
}

void Manage::DasmARM::FreeRegs(Dasm_Regs *regs)
{
	MemFree(regs);
}
...
Bool Manage::DasmARM::DasmNext(Manage::DasmARM::DasmARM_Sess *sess, WChar *buff, OSInt *outBuffSize)
{
/*	*buff = 0;
	if (outBuffSize)
	{
