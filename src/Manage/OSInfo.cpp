...
void Manage::OSInfo::GetCommonName(Text::StringBuilderUTF8 *sb, OSType osType, Text::CString osVer)
{
	if (osType == Manage::OSInfo::OT_DARWIN)
	{
		...
		else if (osVer.Equals(UTF8STRC("18.7.0")))
		{
	...
	else if (osType == OT_WINDOWS_NT)
	{
		...
		else if (osVer.Equals(UTF8STRC("5.0")))
		{
			sb->AppendC(UTF8STRC("Windows 2000"));
		}
		else if (osVer.Equals(UTF8STRC("5.1")))
		{
			sb->AppendC(UTF8STRC("Windows XP"));
		}
		else if (osVer.Equals(UTF8STRC("6.0")))
		{
			sb->AppendC(UTF8STRC("Windows Vista"));
		}
		else if (osVer.Equals(UTF8STRC("6.1")))
		{
			sb->AppendC(UTF8STRC("Windows 7 (32-bit)"));
		}
		else if (osVer.Equals(UTF8STRC("6.2")))
		{
			sb->AppendC(UTF8STRC("Windows 8 (32-bit)"));
		}
		else if (osVer.Equals(UTF8STRC("6.3")))
		{
			sb->AppendC(UTF8STRC("Windows 8.1 (32-bit)"));
		}
		else if (osVer.Equals(UTF8STRC("10.0")))
		{
	...
	else if (osType == OT_WINDOWS_NT64)
	{
		...
		else if (osVer.Equals(UTF8STRC("5.2")))
		{
