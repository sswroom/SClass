...
const UTF8Char *IO::BTUtil::GetManufacturerName(UInt16 manuf)
{
	OSInt i = 0;
	...
	while (i <= j)
	{
		...
		{
			return (const UTF8Char*)compId[k].name;
		}
	}
...
const UTF8Char *IO::BTUtil::GetUUIDName(UInt16 uuid)
{
	...
	while (i <= j)
	{
		...
		{
			return (const UTF8Char*)uuids[k].name;
		}
	}
	return (const UTF8Char*)"Unknown";
}

void IO::BTUtil::GetServiceName(Text::StringBuilderUTF *sb, void *serviceUUID)
{
