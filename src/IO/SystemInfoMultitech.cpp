...
IO::SystemInfo::SystemInfo()
{
	...
	Int64 flen;
	IO::FileStream *fs;
	NEW_CLASS(fs, IO::FileStream((const UTF8Char*)"/sys/class/i2c-dev/i2c-0/device/0-0056/eeprom", IO::FileStream::FILE_MODE_READONLY, IO::FileStream::FILE_SHARE_DENY_NONE, IO::FileStream::BT_NORMAL));
	if (!fs->IsError())
	{
		flen = fs->GetLength();
