...
IO::RS232GPIO::RS232GPIO(IO::GPIOControl *gpio, UOSInt rxdPin, UOSInt txdPin, Int32 baudRate) : IO::Stream(UTF8STRC("RS-232"))
{
	...
	RS232GPIO_Serial - new SoftwareSerial(8, 7, false);
}
...
OSInt IO::RS232GPIO::Read(UInt8 *buff, OSInt size)
{
	...
	{
		*buff++ = (UInt8)RS232GPIO_Serial->read();
		retSize++;
	}
	return retSize;
}
...
Int32 IO::RS232GPIO::EndRead(void *reqData, Bool toWait, OutParam<Bool> incomplete)
{
	if (incomplete)
	{
		*incomplete = false;
