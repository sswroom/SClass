...
IO::ProtoHdlr::ProtoLBSGateHandler::ProtoLBSGateHandler(NotNullPtr<IO::IProtocolHandler::DataListener> listener)
{
...
UOSInt IO::ProtoHdlr::ProtoLBSGateHandler::ParseProtocol(NotNullPtr<IO::Stream> stm, void *stmObj, void *stmData, const Data::ByteArrayR &srcBuff)
{
	Bool found;
	UInt32 crcVal;
