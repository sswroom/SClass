...
IO::Device::ED527::ED527(IO::MODBUSMaster *modbus, UInt8 addr) : IO::MODBUSDevice(modbus, addr)
{
}
...
void IO::Device::ED527::GetDataEntries(UInt8 addr, MODBUSDataEntry dataHdlr, void *userObj)
{
	...
	dataHdlr(userObj, CSTR("RL8"),         addr,     9, IO::MODBUSController::DT_U8,   Math::Unit::UnitBase::VT_MAPPING,      0, 1);
	dataHdlr(userObj, CSTR("RL9"),         addr,    10, IO::MODBUSController::DT_U8,   Math::Unit::UnitBase::VT_MAPPING,      0, 1);
	dataHdlr(userObj, CSTR("RL10"),        addr,    11, IO::MODBUSController::DT_U8,   Math::Unit::UnitBase::VT_MAPPING,      0, 1);
	dataHdlr(userObj, CSTR("RL11"),        addr,    12, IO::MODBUSController::DT_U8,   Math::Unit::UnitBase::VT_MAPPING,      0, 1);
	dataHdlr(userObj, CSTR("RL12"),        addr,    13, IO::MODBUSController::DT_U8,   Math::Unit::UnitBase::VT_MAPPING,      0, 1);
	dataHdlr(userObj, CSTR("RL13"),        addr,    14, IO::MODBUSController::DT_U8,   Math::Unit::UnitBase::VT_MAPPING,      0, 1);
	dataHdlr(userObj, CSTR("RL14"),        addr,    15, IO::MODBUSController::DT_U8,   Math::Unit::UnitBase::VT_MAPPING,      0, 1);
	dataHdlr(userObj, CSTR("RL15"),        addr,    16, IO::MODBUSController::DT_U8,   Math::Unit::UnitBase::VT_MAPPING,      0, 1);
}
