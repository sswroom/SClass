...
void IO::Device::ED516::GetDataEntries(UInt8 addr, MODBUSDataEntry dataHdlr, void *userObj)
{
	...
	dataHdlr(userObj, CSTR("Din 8"),        addr, 10009, IO::MODBUSController::DT_U8,   Math::Unit::UnitBase::ValueType::Mapping,      0, 1);
	dataHdlr(userObj, CSTR("Din 9"),        addr, 10010, IO::MODBUSController::DT_U8,   Math::Unit::UnitBase::ValueType::Mapping,      0, 1);
	dataHdlr(userObj, CSTR("Din 10"),       addr, 10011, IO::MODBUSController::DT_U8,   Math::Unit::UnitBase::ValueType::Mapping,      0, 1);
	dataHdlr(userObj, CSTR("Din 11"),       addr, 10012, IO::MODBUSController::DT_U8,   Math::Unit::UnitBase::ValueType::Mapping,      0, 1);
	dataHdlr(userObj, CSTR("Din 12"),       addr, 10013, IO::MODBUSController::DT_U8,   Math::Unit::UnitBase::ValueType::Mapping,      0, 1);
	dataHdlr(userObj, CSTR("Din 13"),       addr, 10014, IO::MODBUSController::DT_U8,   Math::Unit::UnitBase::ValueType::Mapping,      0, 1);
	dataHdlr(userObj, CSTR("Din 14"),       addr, 10015, IO::MODBUSController::DT_U8,   Math::Unit::UnitBase::ValueType::Mapping,      0, 1);
	dataHdlr(userObj, CSTR("Din 15"),       addr, 10016, IO::MODBUSController::DT_U8,   Math::Unit::UnitBase::ValueType::Mapping,      0, 1);
	...
	dataHdlr(userObj, CSTR("Din 8 Count"),  addr, 40009, IO::MODBUSController::DT_U16,  Math::Unit::UnitBase::ValueType::Count,        Math::Unit::Count::CU_UNIT, 1);
	dataHdlr(userObj, CSTR("Din 9 Count"),  addr, 40010, IO::MODBUSController::DT_U16,  Math::Unit::UnitBase::ValueType::Count,        Math::Unit::Count::CU_UNIT, 1);
	dataHdlr(userObj, CSTR("Din 10 Count"), addr, 40011, IO::MODBUSController::DT_U16,  Math::Unit::UnitBase::ValueType::Count,        Math::Unit::Count::CU_UNIT, 1);
	dataHdlr(userObj, CSTR("Din 11 Count"), addr, 40012, IO::MODBUSController::DT_U16,  Math::Unit::UnitBase::ValueType::Count,        Math::Unit::Count::CU_UNIT, 1);
	dataHdlr(userObj, CSTR("Din 12 Count"), addr, 40013, IO::MODBUSController::DT_U16,  Math::Unit::UnitBase::ValueType::Count,        Math::Unit::Count::CU_UNIT, 1);
	dataHdlr(userObj, CSTR("Din 13 Count"), addr, 40014, IO::MODBUSController::DT_U16,  Math::Unit::UnitBase::ValueType::Count,        Math::Unit::Count::CU_UNIT, 1);
	dataHdlr(userObj, CSTR("Din 14 Count"), addr, 40015, IO::MODBUSController::DT_U16,  Math::Unit::UnitBase::ValueType::Count,        Math::Unit::Count::CU_UNIT, 1);
	dataHdlr(userObj, CSTR("Din 15 Count"), addr, 40016, IO::MODBUSController::DT_U16,  Math::Unit::UnitBase::ValueType::Count,        Math::Unit::Count::CU_UNIT, 1);
}
