...
void IO::JavaClass::Decompile(const UInt8 *codeAttr, Bool staticFunc, const UTF8Char *typeBuff, const UInt8 *lvTable, UOSInt lvTableLen, UOSInt lev, Text::StringBuilderUTF *sb)
{
