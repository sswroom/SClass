...
// MTK MT7621
//https://github.com/torvalds/linux/blob/master/drivers/gpio/gpio-mt7621.c
#define IO_BASE_ADDR 0x1E000000
...
IO::GPIOControl::GPIOControl()
{
	...
	clsData->gpioPtr = (volatile UInt32 *)(clsData->mem->GetPointer().Ptr() + 0x600);
	clsData->sysCtlPtr = (volatile UInt32 *)(clsData->mem->GetPointer().Ptr() + 0x000);
