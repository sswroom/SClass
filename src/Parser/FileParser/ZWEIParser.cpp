...
void Parser::FileParser::ZWEIParser::PrepareSelector(NN<IO::FileSelector> selector, IO::ParserType t)
{
...
Optional<IO::ParsedObject> Parser::FileParser::ZWEIParser::ParseFileHdr(NN<IO::StreamData> fd, Optional<IO::PackageFile> pkgFile, IO::ParserType targetType, Data::ByteArrayR hdr)
{
	UInt32 extCnt;
	UInt32 extOfst;
	UInt32 fileOfst;
