...
/*	NEW_CLASSNN(nnoutImg, Media::StaticImage(imgWidth, imgHeight, 0, bpp, 0, 0, Media::ColorProfile::YUVT_UNKNOWN, (bpp == 32)?Media::AT_ALPHA:Media::AT_NO_ALPHA, Media::YCOFST_C_CENTER_LEFT));
	outImg = nnoutImg;
