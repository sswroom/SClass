...
void Parser::FileParser::GZIPParser::PrepareSelector(IO::FileSelector *selector, IO::ParserType t)
{
...
IO::ParsedObject *Parser::FileParser::GZIPParser::ParseFileHdr(IO::StreamData *fd, IO::PackageFile *pkgFile, IO::ParserType targetType, const UInt8 *hdr)
{
	UInt8 footer[8];
	UTF8Char sbuff[512];
	UOSInt byteConv = 0;
