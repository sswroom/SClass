...
void Parser::FileParser::BurikoPackFileParser::PrepareSelector(IO::IFileSelector *selector, IO::ParsedObject::ParserType t)
{
...
IO::ParsedObject::ParserType Parser::FileParser::BurikoPackFileParser::GetParserType()
{
	return IO::ParsedObject::PT_PACKAGE_PARSER;
}

IO::ParsedObject *Parser::FileParser::BurikoPackFileParser::ParseFile(IO::IStreamData *fd, IO::PackageFile *pkgFile, IO::ParsedObject::ParserType targetType)
{
	UInt8 hdrBuff[16];
	UInt32 dataOfst;
	UInt32 recCnt;
