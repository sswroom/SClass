...
IO::ParsedObject *Parser::FileParser::BurikoPackFileParser::ParseFileHdr(NN<IO::StreamData> fd, IO::PackageFile *pkgFile, IO::ParserType targetType, const UInt8 *hdr)
{
	UInt32 dataOfst;
	UInt32 recCnt;
	UInt32 i;
