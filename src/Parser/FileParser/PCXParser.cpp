...
//	return 0;
	...
	NEW_CLASSNN(outImg, Media::StaticImage(Math::Size2D<UIntOS>(imgWidth, imgHeight), 0, bpp, Media::PixelFormatGetDef(0, bpp), 0, Media::ColorProfile(), Media::ColorProfile::YUVT_UNKNOWN, Media::AT_IGNORE_ALPHA, Media::YCOFST_C_CENTER_LEFT));
