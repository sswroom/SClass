...
void Parser::FileParser::MRGParser::PrepareSelector(NN<IO::FileSelector> selector, IO::ParserType t)
{
...
Optional<IO::ParsedObject> Parser::FileParser::MRGParser::ParseFileHdr(NN<IO::StreamData> fd, Optional<IO::PackageFile> pkgFile, IO::ParserType targetType, Data::ByteArrayR hdr)
{
	UInt32 startOfst;
	UInt64 currOfst;
	UInt32 currSize;
