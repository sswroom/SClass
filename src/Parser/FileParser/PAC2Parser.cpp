...
void Parser::FileParser::PAC2Parser::PrepareSelector(NotNullPtr<IO::FileSelector> selector, IO::ParserType t)
{
...
IO::ParsedObject *Parser::FileParser::PAC2Parser::ParseFileHdr(NotNullPtr<IO::StreamData> fd, IO::PackageFile *pkgFile, IO::ParserType targetType, const UInt8 *hdr)
{
	UInt32 recCnt;
	UInt32 dataOfst;
