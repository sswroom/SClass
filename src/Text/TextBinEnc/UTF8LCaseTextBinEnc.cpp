...
UOSInt Text::TextBinEnc::UTF8LCaseTextBinEnc::CalcBinSize(const UTF8Char *str, UOSInt strLen) const
{
	return strLen;
}

UOSInt Text::TextBinEnc::UTF8LCaseTextBinEnc::DecodeBin(const UTF8Char *str, UOSInt strLen, UInt8 *dataBuff) const
{
