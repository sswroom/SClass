...
UOSInt Text::StrReplace(UTF16Char *str1, UTF16Char oriC, UTF16Char destC)
{
	UTF16Char c;
	UOSInt chrCnt = 0;
	while ((c = *str1++) != 0)
...
UOSInt Text::StrReplace(UTF32Char *str1, UTF32Char oriC, UTF32Char destC)
{
	UTF32Char c;
	UOSInt chrCnt = 0;
	while ((c = *str1++) != 0)
...
UOSInt Text::StrReplace(UTF16Char *str1, const UTF16Char *replaceFrom, const UTF16Char *replaceTo)
{
	UOSInt cnt;
	UOSInt fromCharCnt;
	UOSInt toCharCnt;
...
UOSInt Text::StrReplace(UTF32Char *str1, const UTF32Char *replaceFrom, const UTF32Char *replaceTo)
{
	UOSInt cnt;
	UOSInt fromCharCnt;
	UOSInt toCharCnt;
...
UOSInt Text::StrReplaceICase(UTF16Char *str1, const UTF16Char *replaceFrom, const UTF16Char *replaceTo)
{
	UOSInt cnt;
	UOSInt fromCharCnt;
	UOSInt toCharCnt;
...
UOSInt Text::StrReplaceICase(UTF32Char *str1, const UTF32Char *replaceFrom, const UTF32Char *replaceTo)
{
	UOSInt cnt;
	UOSInt fromCharCnt;
	UOSInt toCharCnt;
...
UTF16Char *Text::StrUTF8_UTF16(UTF16Char *buff, const UTF8Char *bytes, OSInt byteSize, UOSInt *byteConv)
{
...
UOSInt Text::StrUTF8_UTF16Cnt(const UTF8Char *bytes, OSInt byteSize)
{
	UOSInt charCnt = 0;
	if (byteSize < 0)
	{
...
UTF32Char *Text::StrUTF8_UTF32(UTF32Char *buff, const UTF8Char *bytes, OSInt byteSize, UOSInt *byteConv)
{
	const UInt8 *oriBytes = bytes;
	UTF32Char code;
	if (byteSize < 0)
...
UOSInt Text::StrUTF8_UTF32Cnt(const UTF8Char *bytes, OSInt byteSize)
{
	UOSInt charCnt = 0;
	if (byteSize < 0)
	{
...
UTF8Char* Text::StrUTF16_UTF8(UTF8Char *bytes, const UTF16Char *wstr, OSInt strLen)
{
	...
	if (strLen == -1)
	{
		while (true)
		{
			...
			{
				code = 0x10000 + ((UTF32Char)(c - 0xd800) << 10) + (wstr[0] - 0xdc00);
				wstr++;
				if (code < 0x200000)
				{
	...
	else
	{
		while (strLen-- > 0)
		{
			...
			{
				code = 0x10000 + ((c - 0xd800) << 10) + (wstr[0] - 0xdc00);
				wstr++;
				strLen--;
				if (code < 0x200000)
				{
...
UOSInt Text::StrUTF16_UTF8Cnt(const UTF16Char *stri, OSInt strLen)
{
	...
	if (strLen == -1)
	{
		...
		while (true)
		{
			...
			{
				code = 0x10000 + ((c - 0xd800) << 10) + (stri[0] - 0xdc00);
				stri++;
				if (code < 0x200000)
				{
					byteCnt += 4;
...
UTF32Char *Text::StrUTF16_UTF32(UTF32Char *oriStr, const UTF16Char *strToJoin)
{
	...
	while ((c = *strToJoin++) != 0)
	{
		...
		{
			*oriStr++ = 0x10000 + ((c - 0xd800) << 10) + (strToJoin[0] - 0xdc00);
			strToJoin++;
		}
		else
		{
...
const UTF16Char *Text::StrReadChar(const UTF16Char *sptr, UTF32Char *outChar)
{
	...
	{
		*outChar = 0x10000 + ((c - 0xd800) << 10) + (sptr[0] - 0xdc00);
		sptr++;
	}
	else
	{
...
UTF8Char *Text::StrWriteChar(UTF8Char *sptr, UTF32Char c)
{
	if (c < 0x80)
	{
		*sptr++ = (UInt8)c;
