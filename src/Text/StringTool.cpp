...
void Text::StringTool::BuildString(Text::StringBuilderUTF *sb, Text::String *s)
{
	if (s == 0)
	{
...
void Text::StringTool::BuildString(Text::StringBuilderUTF *sb, Data::ReadingList<const UTF8Char*> *list)
{
	if (list == 0)
	{
		sb->Append((const UTF8Char*)"null");
...
void Text::StringTool::BuildString(Text::StringBuilderUTF *sb, Data::ReadingList<Text::String*> *list)
{
	if (list == 0)
	{
		sb->Append((const UTF8Char*)"null");
