...
DB::DBReader *DB::MongoDB::GetTableData(const UTF8Char *name, Data::ArrayList<Text::String*> *columNames, UOSInt ofst, UOSInt maxCnt, const UTF8Char *ordering, Data::QueryConditions *condition)
{
	return 0;
}
