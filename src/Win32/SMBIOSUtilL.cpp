...
Win32::SMBIOS *Win32::SMBIOSUtil::GetSMBIOS()
{
	...
	IO::FileStream *fs;
	NEW_CLASS(fs, IO::FileStream((const UTF8Char*)"/sys/firmware/dmi/tables/smbios_entry_point", IO::FileStream::FileMode::ReadOnly, IO::FileStream::FileShare::DenyNone, IO::FileStream::BufferType::Normal));
	if (!fs->IsError())
	{
...
//				UInt32 cnt = ReadUInt16(&buffTmp[0x1c]);
				...
				NEW_CLASS(fs, IO::FileStream((const UTF8Char*)"/sys/firmware/dmi/tables/DMI", IO::FileStream::FileMode::ReadOnly, IO::FileStream::FileShare::DenyNone, IO::FileStream::BufferType::Normal));
				if (!fs->IsError())
				{
