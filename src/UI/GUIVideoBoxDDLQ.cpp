...
UI::GUIVideoBoxDDLQ::GUIVideoBoxDDLQ(NotNullPtr<UI::GUICore> ui, UI::GUIClientControl *parent, NotNullPtr<Media::ColorManagerSess> colorSess, UOSInt buffCnt, UOSInt threadCnt) : UI::GUIVideoBoxDD(ui, parent, colorSess, buffCnt, threadCnt)
{
}
