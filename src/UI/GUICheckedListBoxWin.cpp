...
UI::GUICheckedListBox::GUICheckedListBox(NotNullPtr<GUICore> ui, NotNullPtr<UI::GUIClientControl> parent) : UI::GUIListView(ui, parent, UI::GUIListView::LVSTYLE_SMALLICON, 0)
{
