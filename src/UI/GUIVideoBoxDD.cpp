...
#ifdef _DEBUG
	NEW_CLASS(this->debugFS, IO::FileStream((const UTF8Char*)"videoProc.log", IO::FileStream::FileMode::Append, IO::FileStream::FileShare::DenyNone, IO::FileStream::BufferType::Normal));
	NEW_CLASS(this->debugLog, IO::StreamWriter(this->debugFS, 65001));
	NEW_CLASS(this->debugFS2, IO::FileStream((const UTF8Char*)"videoDisp.log", IO::FileStream::FileMode::Append, IO::FileStream::FileShare::DenyNone, IO::FileStream::BufferType::Normal));
