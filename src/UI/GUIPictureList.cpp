...
UI::GUIPictureList::GUIPictureList(NotNullPtr<UI::GUICore> ui, UI::GUIClientControl *parent, Media::DrawEngine *eng, Bool hasBorder, Math::Size2D<UOSInt> iconSize) : UI::GUICustomDrawVScroll(ui, parent, eng)
{
