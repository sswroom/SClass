...
Bool UI::GTK::GTKFontDialog::ShowDialog(Optional<ControlHandle> ownerHandle)
{
	GtkWidget *dlg = gtk_font_chooser_dialog_new("Select Font", (GtkWindow*)ownerHandle.OrNull());
	NN<Text::String> s;
