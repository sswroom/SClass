...
void UI::GTK::GTKButton::SetFont(Text::CString fontName, Double fontHeightPt, Bool isBold)
{
	...
	if (fontName.SetTo(nnname)) builder.AddFontFamily(nnname.v);
	...
	{
		pango_font_description_set_family(font, (const Char*)nnname.v.Ptr());
	}
