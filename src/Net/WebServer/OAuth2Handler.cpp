...
{
	this->AddService(authPath, Net::WebServer::IWebRequest::RequestMethod::HTTP_POST, AuthHandler);
	this->AddService(tokenPath, Net::WebServer::IWebRequest::RequestMethod::HTTP_POST, TokenHandler);
	this->AddService(userinfoPath, Net::WebServer::IWebRequest::RequestMethod::HTTP_POST, UserInfoHandler);
}
