...
void Net::WebServer::WebServerRequest::AddHeader(Text::CStringNN name, Text::CStringNN value)
{
	Optional<Text::String> s = this->headers.PutC(name, Text::String::New(value));
	OPTSTR_DEL(s);
}

Optional<Text::String> Net::WebServer::WebServerRequest::GetSHeader(Text::CStringNN name) const
{
...
Bool Net::WebServer::WebServerRequest::GetHeaderC(NN<Text::StringBuilderUTF8> sb, Text::CStringNN name) const
{
	NN<Text::String> hdr;
...
NN<Text::String> Net::WebServer::WebServerRequest::GetRequestURI() const
{
	return this->requestURI;
}

Net::WebServer::WebRequest::RequestProtocol Net::WebServer::WebServerRequest::GetProtocol() const
{
...
NN<const Net::SocketUtil::AddressInfo> Net::WebServer::WebServerRequest::GetClientAddr() const
{
	return this->cliAddr;
}

NN<Net::NetConnection> Net::WebServer::WebServerRequest::GetNetConn() const
{
	return this->cli;
}

UInt16 Net::WebServer::WebServerRequest::GetClientPort() const
{
	return this->cliPort;
}

Bool Net::WebServer::WebServerRequest::IsSecure() const
{
	return this->cli->IsSSL() || this->IsForwardedSSL();
}

Optional<Crypto::Cert::X509Cert> Net::WebServer::WebServerRequest::GetClientCert()
{
...
Bool Net::WebServer::WebServerRequest::IsForwardedSSL() const
{
	NN<Text::String> s;
...
Bool Net::WebServer::WebServerRequest::HasData()
{
