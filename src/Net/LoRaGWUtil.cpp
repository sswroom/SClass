...
void Net::LoRaGWUtil::ParseGWMPMessage(Text::StringBuilderUTF8 *sb, Bool toServer, UInt8 ver, UInt16 token, UInt8 msgType, const UInt8 *msg, UOSInt msgSize)
{
	if (toServer)
	{
...
void Net::LoRaGWUtil::ParseUDPMessage(Text::StringBuilderUTF8 *sb, Bool toServer, const UInt8 *msg, UOSInt msgSize)
{
...
void Net::LoRaGWUtil::GenRxpkJSON(Text::StringBuilderUTF8 *sb, UInt32 freq, UInt32 chan, UInt32 rfch, UInt32 codrk, Int32 rssi, Int32 lsnr, const UInt8 *data, UOSInt dataSize)
{
	UTF8Char sbuff[64];
	UTF8Char *sptr;
