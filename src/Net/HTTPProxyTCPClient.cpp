...
Net::HTTPProxyTCPClient::HTTPProxyTCPClient(NotNullPtr<Net::SocketFactory> sockf, Text::CStringNN proxyHost, UInt16 proxyPort, PasswordType pt, const UTF8Char *userName, const UTF8Char *pwd, Text::CStringNN destHost, UInt16 destPort) : Net::TCPClient(sockf, (Socket*)0)
{
