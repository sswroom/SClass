...
Net::HTTPData::HTTPData(NotNullPtr<Net::SocketFactory> sockf, Net::SSLEngine *ssl, Net::HTTPQueue *queue, Text::CString url, Text::CString localFile, Bool forceReload)
{
	UOSInt i;
