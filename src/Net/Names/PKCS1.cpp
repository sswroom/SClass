...
void __stdcall Net::Names::PKCS1::RSAPublicKey(NN<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("RSAPublicKey"), RSAPublicKeyCont);
}

void __stdcall Net::Names::PKCS1::RSAPublicKeyCont(NN<ASN1Names> names)
{
...
void __stdcall Net::Names::PKCS1::RSAPrivateKey(NN<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("RSAPrivateKey"), RSAPrivateKeyCont);
}

void __stdcall Net::Names::PKCS1::RSAPrivateKeyCont(NN<ASN1Names> names)
{
...
void __stdcall Net::Names::PKCS1::OtherPrimeInfos(NN<ASN1Names> names)
{
...
void __stdcall Net::Names::PKCS1::AddDigestInfo(NN<Net::ASN1Names> names, Text::CStringNN name)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(name, DigestInfoCont);
}

void __stdcall Net::Names::PKCS1::DigestInfoCont(NN<ASN1Names> names)
{
