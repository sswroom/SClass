...
void Net::Names::PKIX1Implicit88::AuthorityKeyIdentifier(NotNullPtr<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("AuthorityKeyIdentifier"), AuthorityKeyIdentifierCont);
}

void Net::Names::PKIX1Implicit88::AuthorityKeyIdentifierCont(NotNullPtr<ASN1Names> names)
{
...
void Net::Names::PKIX1Implicit88::SubjectKeyIdentifier(NotNullPtr<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_OCTET_STRING)->NextValue(CSTR("SubjectKeyIdentifier"));
}

void Net::Names::PKIX1Implicit88::KeyUsage(NotNullPtr<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_BIT_STRING)->NextValue(CSTR("KeyUsage"));
}

void Net::Names::PKIX1Implicit88::CertificatePolicies(NotNullPtr<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("CertificatePolicies"), CertificatePoliciesCont);
}

void Net::Names::PKIX1Implicit88::CertificatePoliciesCont(NotNullPtr<ASN1Names> names)
{
	names->RepeatIfTypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("PolicyInformation"), PolicyInformationCont);
}

void Net::Names::PKIX1Implicit88::PolicyInformationCont(NotNullPtr<ASN1Names> names)
{
...
void Net::Names::PKIX1Implicit88::PolicyQualifiers(NotNullPtr<ASN1Names> names)
{
	names->RepeatIfTypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("PolicyQualifierInfo"), PolicyQualifierInfoCont);
}

void Net::Names::PKIX1Implicit88::PolicyQualifierInfoCont(NotNullPtr<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_OID)->NextValue(CSTR("policyQualifierId"));
	names->NextValue(CSTR("qualifier"));
}

void Net::Names::PKIX1Implicit88::GeneralNames(NotNullPtr<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("GeneralName"), GeneralNameCont);
}

void Net::Names::PKIX1Implicit88::GeneralNameCont(NotNullPtr<ASN1Names> names)
{
...
void Net::Names::PKIX1Implicit88::BasicConstraints(NotNullPtr<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("BasicConstraints"), BasicConstraintsCont);
}

void Net::Names::PKIX1Implicit88::BasicConstraintsCont(NotNullPtr<ASN1Names> names)
{
...
void Net::Names::PKIX1Implicit88::CRLDistributionPoints(NotNullPtr<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("CRLDistributionPoints"), CRLDistributionPointsCont);
}

void Net::Names::PKIX1Implicit88::CRLDistributionPointsCont(NotNullPtr<ASN1Names> names)
{
	names->RepeatIfTypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("DistributionPoint"), DistributionPointCont);
}

void Net::Names::PKIX1Implicit88::DistributionPointCont(NotNullPtr<ASN1Names> names)
{
...
void Net::Names::PKIX1Implicit88::DistributionPointName(NotNullPtr<ASN1Names> names)
{
...
void Net::Names::PKIX1Implicit88::ReasonFlags(NotNullPtr<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_BIT_STRING)->NextValue(CSTR("ReasonFlags"));
}

void Net::Names::PKIX1Implicit88::ExtKeyUsageSyntax(NotNullPtr<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("ExtKeyUsageSyntax"), ExtKeyUsageSyntaxCont);
}

void Net::Names::PKIX1Implicit88::ExtKeyUsageSyntaxCont(NotNullPtr<ASN1Names> names)
{
