...
void __stdcall Net::Names::PKIX1Implicit88::AuthorityKeyIdentifier(NN<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("AuthorityKeyIdentifier"), AuthorityKeyIdentifierCont);
}

void __stdcall Net::Names::PKIX1Implicit88::AuthorityKeyIdentifierCont(NN<ASN1Names> names)
{
...
void __stdcall Net::Names::PKIX1Implicit88::SubjectKeyIdentifier(NN<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_OCTET_STRING)->NextValue(CSTR("SubjectKeyIdentifier"));
}

void __stdcall Net::Names::PKIX1Implicit88::KeyUsage(NN<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_BIT_STRING)->NextValue(CSTR("KeyUsage"));
}

void __stdcall Net::Names::PKIX1Implicit88::CertificatePolicies(NN<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("CertificatePolicies"), CertificatePoliciesCont);
}

void __stdcall Net::Names::PKIX1Implicit88::CertificatePoliciesCont(NN<ASN1Names> names)
{
	names->RepeatIfTypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("PolicyInformation"), PolicyInformationCont);
}

void __stdcall Net::Names::PKIX1Implicit88::PolicyInformationCont(NN<ASN1Names> names)
{
...
void __stdcall Net::Names::PKIX1Implicit88::PolicyQualifiers(NN<ASN1Names> names)
{
	names->RepeatIfTypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("PolicyQualifierInfo"), PolicyQualifierInfoCont);
}

void __stdcall Net::Names::PKIX1Implicit88::PolicyQualifierInfoCont(NN<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_OID)->NextValue(CSTR("policyQualifierId"));
	names->NextValue(CSTR("qualifier"));
}

void __stdcall Net::Names::PKIX1Implicit88::GeneralNames(NN<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("GeneralName"), GeneralNameCont);
}

void __stdcall Net::Names::PKIX1Implicit88::GeneralNameCont(NN<ASN1Names> names)
{
...
void __stdcall Net::Names::PKIX1Implicit88::BasicConstraints(NN<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("BasicConstraints"), BasicConstraintsCont);
}

void __stdcall Net::Names::PKIX1Implicit88::BasicConstraintsCont(NN<ASN1Names> names)
{
...
void __stdcall Net::Names::PKIX1Implicit88::CRLDistributionPoints(NN<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("CRLDistributionPoints"), CRLDistributionPointsCont);
}

void __stdcall Net::Names::PKIX1Implicit88::CRLDistributionPointsCont(NN<ASN1Names> names)
{
	names->RepeatIfTypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("DistributionPoint"), DistributionPointCont);
}

void __stdcall Net::Names::PKIX1Implicit88::DistributionPointCont(NN<ASN1Names> names)
{
...
void __stdcall Net::Names::PKIX1Implicit88::DistributionPointName(NN<ASN1Names> names)
{
...
void __stdcall Net::Names::PKIX1Implicit88::ReasonFlags(NN<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_BIT_STRING)->NextValue(CSTR("ReasonFlags"));
}

void __stdcall Net::Names::PKIX1Implicit88::ExtKeyUsageSyntax(NN<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("ExtKeyUsageSyntax"), ExtKeyUsageSyntaxCont);
}

void __stdcall Net::Names::PKIX1Implicit88::ExtKeyUsageSyntaxCont(NN<ASN1Names> names)
{
