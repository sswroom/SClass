...
void Net::Names::PKCS8::PrivateKeyInfo(NN<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("PrivateKeyInfo"), PrivateKeyInfoCont);
}

void Net::Names::PKCS8::PrivateKeyInfoCont(NN<ASN1Names> names)
{
...
void Net::Names::PKCS8::EncryptedPrivateKeyInfo(NN<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("EncryptedPrivateKeyInfo"), EncryptedPrivateKeyInfoCont);
}

void Net::Names::PKCS8::EncryptedPrivateKeyInfoCont(NN<ASN1Names> names)
{
