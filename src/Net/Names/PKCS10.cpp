...
void Net::Names::PKCS10::AddCertificationRequestInfo(NotNullPtr<Net::ASN1Names> names, Text::CStringNN name)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(name, CertificationRequestInfoCont);
}

void Net::Names::PKCS10::CertificationRequestInfoCont(NotNullPtr<ASN1Names> names)
{
...
void Net::Names::PKCS10::AttributesCont(NotNullPtr<ASN1Names> names)
{
	names->RepeatIfTypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("Attribute"), InformationFramework::AttributeCont);
}

void Net::Names::PKCS10::CertificationRequest(NotNullPtr<ASN1Names> names)
{
	names->TypeIs(Net::ASN1Util::IT_SEQUENCE)->Container(CSTR("CertificationRequest"), CertificationRequestCont);
}

void Net::Names::PKCS10::CertificationRequestCont(NotNullPtr<ASN1Names> names)
{
