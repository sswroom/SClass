...
Net::ProtoClient::ProtoClient(NN<Net::SocketFactory> sockf, Text::CString cliAddr, UInt16 cliPort, IO::IProtocolHandler *proto, Net::ProtoClient::IProtoClientHandler *cliHdlr)
{
	this->sockf = sockf;
	this->cli = 0;
