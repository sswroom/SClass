...
Net::PushServer::PushServer(NN<Net::SocketFactory> sockf, Optional<Net::SSLEngine> ssl, UInt16 port, Text::CString fcmKey, NN<IO::LogTool> log) : mgr(sockf, ssl, fcmKey, log)
{
	this->sockf = sockf;
	this->listener = 0;
