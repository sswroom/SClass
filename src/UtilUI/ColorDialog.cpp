...
void UtilUI::ColorDialog::YUVParamChanged(NN<const Media::ColorHandler::YUVPARAM> yuvParam)
{
}

void UtilUI::ColorDialog::RGBParamChanged(NN<const Media::ColorHandler::RGBPARAM2> rgbParam)
{
	this->UpdateColor();
	this->GenMainImage();
	this->GenSubImage();
