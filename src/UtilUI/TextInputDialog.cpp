...
UtilUI::TextInputDialog::TextInputDialog(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, Media::MonitorMgr *monMgr, Text::CString title, Text::CString message) : UI::GUIForm(parent, 320, 120, ui)
{
