...
void Map::MapLayerCfg::DrawChars(Media::DrawImage *img, const WChar *str1, Int32 scnPosX, Int32 scnPosY, Int32 scaleW, Int32 scaleH, Data::ArrayList<MapFontStyle*> *fontStyle, Bool isAlign)
{
	...
	Int32 maxIndex;
	OSInt lblSize;
	Map::MapLayerCfg::MapFontStyle *font;
	Map::MapLayerCfg::MapFontStyle *font2;
	...
	while (i < fntCount)
	{
		font = (Map::MapLayerCfg::MapFontStyle*)fontStyle->GetItem(i);
		if (font->fontType == 0)
		{
	...
	font = (Map::MapLayerCfg::MapFontStyle*)fontStyle->GetItem(maxIndex);
	if (scaleH == 0)
	{
		scaleH = 0;
	}
	...
	if (scaleH == 0) //scaleW == 0 && scaleH == 0)
	{
		...
		while (i < fntCount)
		{
			...
			if (font->fontType == 1)
			{
				...
				if (i < fntCount - 1)
				{
					font2 = (Map::MapLayerCfg::MapFontStyle*)fontStyle->GetItem(i + 1);
...
void Map::MapLayerCfg::GetCharsSize(Media::DrawImage *img, Int32 *size, const WChar *label, Data::ArrayList<MapFontStyle*> *fontStyle, Int32 scaleW, Int32 scaleH)
{
	Int32 xSizeAdd = 0;
	Int32 ySizeAdd = 0;
...
Int32 Map::MapLayerCfg::ToColor(const WChar *str)
{
	Int32 v = Text::StrHex2Int(str);
	return 0xff000000 | ((v & 0xff) << 16) | (v & 0xff00) | ((v >> 16) & 0xff);
}

Map::IMapDrawLayer *Map::MapLayerCfg::GetDrawLayer(const WChar *name, Data::ArrayList<Map::IMapDrawLayer*> *layerList)
{
	Map::CIPLayer *cip;
...
void Map::MapLayerCfg::DrawPoints(Media::DrawImage *img, MapLayerStyle *lyrs, Map::MapView *view, Bool *isLayerEmpty, Map::MapScheduler *sch)
{
...
void Map::MapLayerCfg::DrawString(Media::DrawImage *img, MapLayerStyle *lyrs, Map::MapView *view, Data::ArrayList<MapFontStyle*> **fonts, MapLabels *labels, Int32 maxLabels, Int32 *labelCnt, Bool *isLayerEmpty)
{
	void *arr;
	Data::ArrayListInt *arri;
	OSInt i;
...
Int32 Map::MapLayerCfg::NewLabel(MapLabels *labels, Int32 maxLabel, Int32 *labelCnt, Int32 priority)
{
	Int32 minPriority;
	Int32 i;
	Int32 j;
...
Bool Map::MapLayerCfg::AddLabel(MapLabels *labels, Int32 maxLabel, Int32 *labelCnt, const WChar *labelt, Int32 nPoint, Int32 *points, Int32 priority, Int32 recType, Int32 fontStyle, Int32 flags, Map::MapView *view)
{
	Int32 size;
	Int32 visibleSize;
...
void Map::MapLayerCfg::SwapLabel(MapLabels *mapLabels, Int32 index, Int32 index2)
{
	MapLabels l;
...
Int32 Map::MapLayerCfg::LabelOverlapped(Int32 *points, Int32 nPoints, Int32 tlx, Int32 tly, Int32 brx, Int32 bry)
{
	while (nPoints--)
	{
...
void Map::MapLayerCfg::DrawLabels(Media::DrawImage *img, MapLabels *labels, Int32 maxLabel, Int32 *labelCnt, Map::MapView *view, Data::ArrayList<MapFontStyle*> **fonts)
{
	Int32 i;
	Int32 j;
	WChar *dest;
...
Map::MapLayerCfg::MapLayerCfg(WChar *fileName, Media::DrawEngine *eng, Data::ArrayList<Map::IMapDrawLayer*> *layerList, Parser::ParserList *parserList, WChar *forceBase)
{
	WChar lineBuff[1024];
	WChar layerName[512];
	...
	else
	{
		...
		while (rdr->ReadLine(lineBuff, 1023))
		{
			...
			case 5:
				...
				currFont->fontName = Text::StrCopyNew(strs[3]);
...
Map::MapLayerCfg::~MapLayerCfg()
{
	OSInt i;
	OSInt j;
	Map::MapLayerCfg::MapLineStyle *currLine;
	Map::MapLayerCfg::MapFontStyle *currFont;
	Map::MapLayerCfg::MapLayerStyle *currLyr;
	...
	if (this->lines)
	{
		...
		while (i-- > 0)
		{
			if (this->lines[i])
			{
				...
				while (j-- > 0)
				{
					currLine = (Map::MapLayerCfg::MapLineStyle*)this->lines[i]->GetItem(j);
					if (currLine->styles)
					{
						MemFree((WChar*)currLine->styles);
					}
					MemFree(currLine);
				}
	...
	if (this->fonts)
	{
		...
		while (i-- > 0)
		{
			if (this->fonts[i])
			{
				...
				while (j-- > 0)
				{
					currFont = (Map::MapLayerCfg::MapFontStyle*)this->fonts[i]->GetItem(j);
					if (currFont->fontName)
					{
						Text::StrDelNew(currFont->fontName);
					}
					MemFree(currFont);
				}
	...
	if (this->drawList)
	{
		...
		while (i-- > 0)
		{
			currLyr = (Map::MapLayerCfg::MapLayerStyle*)this->drawList->GetItem(i);
			if (currLyr->img)
			{
...
Bool Map::MapLayerCfg::IsError()
{
	return this->drawList == 0;
}

Media::DrawPen *Map::MapLayerCfg::CreatePen(Media::DrawImage *img, Int32 lineStyle, Int32 lineLayer)
{
	...
	if (this->lines[lineStyle] == 0)
		return 0;
	Map::MapLayerCfg::MapLineStyle *thisLine = (Map::MapLayerCfg::MapLineStyle*)this->lines[lineStyle]->GetItem(lineLayer);
	if (thisLine == 0)
		return 0;
...
void Map::MapLayerCfg::DrawMap(Media::DrawImage *img, Map::MapView *view, Bool *isLayerEmpty, Map::MapScheduler *mapSch)
{
	Int32 index;
	Int32 index2;
	OSInt layerCnt = this->drawList->GetCount();
	Data::ArrayListInt *arr;
	Data::ArrayList<Map::MapLayerCfg::MapFontStyle*> **myArrs;
	Data::ArrayList<Map::MapLayerCfg::MapFontStyle*> *fontArr;
	Map::IMapDrawLayer *lyr;
	Map::MapLayerCfg::MapLayerStyle *lyrs;
	Map::DrawObject *dobj;
	Map::MapLayerCfg::MapFontStyle *fnt;
	Map::MapLayerCfg::MapFontStyle *fnt2;
	...
	*isLayerEmpty = true;
	Map::MapLayerCfg::MapLabels *labels = MemAlloc(Map::MapLayerCfg::MapLabels, maxLabel);
	...
	myArrs = MemAlloc(Data::ArrayList<Map::MapLayerCfg::MapFontStyle*>*, this->nFont);
	i = this->nFont;
	while (i-- > 0)
	{
		...
		if (fontArr)
		{
			j = 0;
			k = fontArr->GetCount();
			NEW_CLASS(myArrs[i], Data::ArrayList<Map::MapLayerCfg::MapFontStyle*>());
			while (j < k)
			{
				fnt = (Map::MapLayerCfg::MapFontStyle*)fontArr->GetItem(j);
				fnt2 = MemAlloc(Map::MapLayerCfg::MapFontStyle, 1);
	...
	{
		void *session;
		lyrs = (Map::MapLayerCfg::MapLayerStyle*)this->drawList->GetItem(index++);
...
void Map::MapLayerCfg::ReleaseLayers(Data::ArrayList<Map::IMapDrawLayer*> *layerList)
{
	Map::CIPLayer *lyr;
	OSInt i;
