...
Map::ReverseGeocoderClient::ReverseGeocoderClient(NN<Net::SocketFactory> sockf, Text::CStringNN host, UInt16 port, Map::IReverseGeocoder *revGeo, IO::Writer *errWriter) : protocol(*this)
{
	this->sockf = sockf;
