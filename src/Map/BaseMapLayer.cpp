...
Map::MapDrawLayer *Map::BaseMapLayer::CreateLayer(BaseLayerType blt, NotNullPtr<Net::SocketFactory> sockf, Net::SSLEngine *ssl, Parser::ParserList *parsers)
{
	UTF8Char sbuff[512];
	UTF8Char *sptr;
	...
	case BLT_OSM_TILE:
		...
		NEW_CLASSNN(tileMap, Map::OSM::OSMTileMap(CSTR("http://a.tile.openstreetmap.org/"), CSTRP(sbuff, sptr), 18, sockf, ssl));
	...
	case BLT_OSM_CYCLE:
		...
		NEW_CLASSNN(tileMap, Map::OSM::OSMTileMap(CSTR("http://a.tile.thunderforest.com/cycle/"), CSTRP(sbuff, sptr), 18, sockf, ssl));
	...
	case BLT_OSM_TRANSP:
		...
		NEW_CLASSNN(tileMap, Map::OSM::OSMTileMap(CSTR("http://a.tile.thunderforest.com/transport/"), CSTRP(sbuff, sptr), 18, sockf, ssl));
	...
	case BLT_OSM_LANDSCAPE:
		...
		NEW_CLASSNN(tileMap, Map::OSM::OSMTileMap(CSTR("http://a.tile.thunderforest.com/landscape/"), CSTRP(sbuff, sptr), 18, sockf, ssl));
	...
	case BLT_OSM_OUTDOORS:
		...
		NEW_CLASSNN(tileMap, Map::OSM::OSMTileMap(CSTR("http://a.tile.thunderforest.com/outdoors/"), CSTRP(sbuff, sptr), 18, sockf, ssl));
	...
	case BLT_OSM_TRANSP_DARK:
		...
		NEW_CLASSNN(tileMap, Map::OSM::OSMTileMap(CSTR("http://a.tile.thunderforest.com/transport-dark/"), CSTRP(sbuff, sptr), 18, sockf, ssl));
	...
	case BLT_OSM_SPINAL:
		...
		NEW_CLASSNN(tileMap, Map::OSM::OSMTileMap(CSTR("http://a.tile.thunderforest.com/spinal-map/"), CSTRP(sbuff, sptr), 18, sockf, ssl));
	...
	case BLT_OSM_MAPQUEST:
		...
		NEW_CLASSNN(tileMap, Map::OSM::OSMTileMap(CSTR("http://otile1.mqcdn.com/tiles/1.0.0/osm/"), CSTRP(sbuff, sptr), 18, sockf, ssl));
