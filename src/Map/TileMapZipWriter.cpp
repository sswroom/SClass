...
Map::TileMapZipWriter::TileMapZipWriter(Text::CStringNN fileName, Map::TileMap::TileFormat format, UIntOS minLev, UIntOS maxLev, Math::RectAreaDbl bounds) : fs(fileName, IO::FileMode::Create, IO::FileShare::DenyNone, IO::FileStream::BufferType::Normal), zip(fs, IO::ZIPOS::UNIX)
{
...
Map::TileMapZipWriter::~TileMapZipWriter()
{
	...
	this->zip.AddFile(CSTR("metadata.json"), metadata.v, metadata.leng, t, t, t, Data::Compress::Deflater::CompLevel::BestCompression, 0);
...
void Map::TileMapZipWriter::AddImage(UIntOS level, Int32 x, Int32 y, Data::ByteArrayR imgData, Map::TileMap::TileFormat format)
{
	UTF8Char sbuff[128];
	UnsafeArray<UTF8Char> sptr;
	sptr = Text::StrUIntOS(sbuff, level);
	...
	*sptr++ = '/';
	...
	Data::Timestamp t = Data::Timestamp::UtcNow();
	this->zip.AddFile(CSTRP(sbuff, sptr), imgData.Arr(), imgData.GetSize(), t, t, t, Data::Compress::Deflater::CompLevel::BestCompression, 0);
}
