...
Map::DBAssistedReverseGeocoderPL::AddressComparator::~AddressComparator()
{
}
...
Map::DBAssistedReverseGeocoderPL::DBAssistedReverseGeocoderPL(NN<DB::DBTool> db, NN<IO::Writer> errWriter)
{
	this->conn = db;
...
void Map::DBAssistedReverseGeocoderPL::AddReverseGeocoder(NN<Map::ReverseGeocoder> revGeo)
{
