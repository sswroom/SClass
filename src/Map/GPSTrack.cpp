...
DB::DBReader *Map::GPSTrack::GetTableData(const UTF8Char *tableName, Data::ArrayList<const UTF8Char *> *columnName, UOSInt ofst, UOSInt maxCnt, const UTF8Char *ordering, DB::QueryConditions *condition)
{
	DB::DBReader *r;
