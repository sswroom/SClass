...
Map::MapDrawLayer *Map::RegionalMapSource::OpenMap(const MapInfo *map, NotNullPtr<Net::SocketFactory> sockf, Net::SSLEngine *ssl, Text::EncodingFactory *encFact, Parser::ParserList *parsers, Net::WebBrowser *browser)
{
