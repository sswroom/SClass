...
UTF8Char *Map::MultiReverseGeocoder::SearchName(UTF8Char *buff, UOSInt buffSize, Double lat, Double lon, Int32 lcid)
{
	UTF8Char *sptr = 0;
	mut->Lock();
...
UTF8Char *Map::MultiReverseGeocoder::CacheName(UTF8Char *buff, UOSInt buffSize, Double lat, Double lon, Int32 lcid)
{
	UTF8Char *sptr = 0;
	mut->Lock();
	OSInt i = this->revGeos->GetCount();
