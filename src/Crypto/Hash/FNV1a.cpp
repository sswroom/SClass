...
void Crypto::Hash::FNV1a::Calc(UnsafeArray<const UInt8> buff, UIntOS buffSize)
{
...
UIntOS Crypto::Hash::FNV1a::GetBlockSize() const
{
	return 1;
}

UIntOS Crypto::Hash::FNV1a::GetResultSize() const
{
	return 4;
}
