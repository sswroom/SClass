...
void Crypto::Hash::ExcelHash::Calc(UnsafeArray<const UInt8> buff, UIntOS buffSize)
{
...
UIntOS Crypto::Hash::ExcelHash::GetBlockSize() const
{
	return 1;
}

UIntOS Crypto::Hash::ExcelHash::GetResultSize() const
{
	return 2;
}
