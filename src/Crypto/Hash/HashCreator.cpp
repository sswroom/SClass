...
{
	Optional<Crypto::Hash::HashAlgorithm> hash = nullptr;
	switch (hashType)
	{
	case Crypto::Hash::HashType::Adler32:
		NEW_CLASSOPT(hash, Crypto::Hash::Adler32());
		break;
	case Crypto::Hash::HashType::CRC16:
		NEW_CLASSOPT(hash, Crypto::Hash::CRC16());
		break;
	case Crypto::Hash::HashType::CRC16R:
		NEW_CLASSOPT(hash, Crypto::Hash::CRC16R());
		break;
	case Crypto::Hash::HashType::CRC32:
		NEW_CLASSOPT(hash, Crypto::Hash::CRC32());
		break;
	case Crypto::Hash::HashType::CRC32R_IEEE:
		NEW_CLASSOPT(hash, Crypto::Hash::CRC32R(Crypto::Hash::CRC32::GetPolynormialIEEE()));
		break;
	case Crypto::Hash::HashType::CRC32C:
		NEW_CLASSOPT(hash, Crypto::Hash::CRC32R(Crypto::Hash::CRC32::GetPolynormialCastagnoli()));
		break;
	case Crypto::Hash::HashType::DJB2:
		NEW_CLASSOPT(hash, Crypto::Hash::DJB2());
		break;
	case Crypto::Hash::HashType::DJB2a:
		NEW_CLASSOPT(hash, Crypto::Hash::DJB2a());
		break;
	case Crypto::Hash::HashType::Excel:
		NEW_CLASSOPT(hash, Crypto::Hash::ExcelHash());
		break;
	case Crypto::Hash::HashType::FNV1:
		NEW_CLASSOPT(hash, Crypto::Hash::FNV1());
		break;
	case Crypto::Hash::HashType::FNV1a:
		NEW_CLASSOPT(hash, Crypto::Hash::FNV1a());
		break;
	case Crypto::Hash::HashType::MD5:
		NEW_CLASSOPT(hash, Crypto::Hash::MD5());
		break;
	case Crypto::Hash::HashType::RIPEMD128:
		NEW_CLASSOPT(hash, Crypto::Hash::RIPEMD128());
		break;
	case Crypto::Hash::HashType::RIPEMD160:
		NEW_CLASSOPT(hash, Crypto::Hash::RIPEMD160());
		break;
	case Crypto::Hash::HashType::SDBM:
		NEW_CLASSOPT(hash, Crypto::Hash::SDBM());
		break;
	case Crypto::Hash::HashType::SHA1:
		NEW_CLASSOPT(hash, Crypto::Hash::SHA1());
		break;
	case Crypto::Hash::HashType::SHA224:
		NEW_CLASSOPT(hash, Crypto::Hash::SHA224());
		break;
	case Crypto::Hash::HashType::SHA256:
		NEW_CLASSOPT(hash, Crypto::Hash::SHA256());
		break;
	case Crypto::Hash::HashType::SHA384:
		NEW_CLASSOPT(hash, Crypto::Hash::SHA384());
		break;
	case Crypto::Hash::HashType::SHA512:
		NEW_CLASSOPT(hash, Crypto::Hash::SHA512());
		break;
//	case Crypto::Hash::HashType::SUPERFASTHASH:
//		NEW_CLASSOPT(hash, Crypto::Hash::SuperFastHash());
//		break;
	case Crypto::Hash::HashType::SHA1_SHA1:
		NEW_CLASSOPT(hash, Crypto::Hash::SHA1_SHA1());
		break;
