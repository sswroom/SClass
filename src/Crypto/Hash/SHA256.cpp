...
NN<Crypto::Hash::HashAlgorithm> Crypto::Hash::SHA256::Clone() const
{
...
void Crypto::Hash::SHA256::Calc(UnsafeArray<const UInt8> buff, UIntOS buffSize)
{
...
void Crypto::Hash::SHA256::GetValue(UnsafeArray<UInt8> buff) const
{
	UInt8 calBuff[64];
	UInt32 intHash[8];
...
UIntOS Crypto::Hash::SHA256::GetBlockSize() const
{
	return 64;
}

UIntOS Crypto::Hash::SHA256::GetResultSize() const
{
	return 32;
}
