...
void Crypto::Hash::Bcrypt::CalcHash(UInt32 cost, const UInt8 *salt, Text::CStringNN password, UInt8 *hashBuff)
{
...
Bool Crypto::Hash::Bcrypt::Matches(Text::CStringNN hash, Text::CStringNN password)
{
