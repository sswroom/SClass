...
void Crypto::Hash::SHA384::Calc(UnsafeArray<const UInt8> buff, UIntOS buffSize)
{
...
UIntOS Crypto::Hash::SHA384::GetBlockSize() const
{
	return 128;
}

UIntOS Crypto::Hash::SHA384::GetResultSize() const
{
	return 48;
}
