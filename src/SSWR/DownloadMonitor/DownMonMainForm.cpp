...
SSWR::DownloadMonitor::DownMonMainForm::DownMonMainForm(Optional<UI::GUIClientControl> parent, NN<UI::GUICore> ui, NN<SSWR::DownloadMonitor::DownMonCore> core) : UI::GUIForm(parent, 1024, 768, ui)
{
	this->core = core;
