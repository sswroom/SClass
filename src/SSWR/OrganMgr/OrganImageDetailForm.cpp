...
SSWR::OrganMgr::OrganImageDetailForm::OrganImageDetailForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, OrganEnv *env, UserFileInfo *userFile) : UI::GUIForm(parent, 420, 224, ui)
{
	...
	NEW_CLASS(this->lblFileName, UI::GUILabel(ui, this, this->env->GetLang(UTF8STRC("ImageDetailFileName"))));
	...
	NEW_CLASS(this->lblDescript, UI::GUILabel(ui, this, this->env->GetLang(UTF8STRC("ImageDetailDescript"))));
	...
	NEW_CLASS(this->lblCamera, UI::GUILabel(ui, this, this->env->GetLang(UTF8STRC("ImageDetailCamera"))));
	...
	NEW_CLASS(this->lblLat, UI::GUILabel(ui, this, this->env->GetLang(UTF8STRC("ImageDetailLat"))));
	...
	NEW_CLASS(this->lblLon, UI::GUILabel(ui, this, this->env->GetLang(UTF8STRC("ImageDetailLon"))));
