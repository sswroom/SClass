...
SSWR::OrganMgr::OrganImageDetailForm::OrganImageDetailForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, OrganEnv *env, UserFileInfo *userFile) : UI::GUIForm(parent, 420, 224, ui)
{
	...
	NEW_CLASS(this->lblId, UI::GUILabel(ui, this, this->env->GetLang(CSTR("ImageDetailId"))));
	this->lblId->SetRect(0, 0, 100, 23, false);
	NEW_CLASS(this->txtId, UI::GUITextBox(ui, this, CSTRP(sbuff, sptr)));
	this->txtId->SetRect(100, 0, 100, 23, false);
	this->txtId->SetReadOnly(true);
	NEW_CLASS(this->lblFileName, UI::GUILabel(ui, this, this->env->GetLang(CSTR("ImageDetailFileName"))));
	this->lblFileName->SetRect(0, 24, 100, 23, false);
	NEW_CLASS(this->txtFileName, UI::GUITextBox(ui, this, userFile->oriFileName->ToCString()));
	this->txtFileName->SetRect(100, 24, 300, 23, false);
	this->txtFileName->SetReadOnly(true);
	NEW_CLASS(this->lblDescript, UI::GUILabel(ui, this, this->env->GetLang(CSTR("ImageDetailDescript"))));
	this->lblDescript->SetRect(0, 48, 100, 23, false);
	NEW_CLASS(this->txtDescript, UI::GUITextBox(ui, this, Text::String::OrEmpty(userFile->descript)->ToCString()));
	this->txtDescript->SetRect(100, 48, 300, 23, false);
	NEW_CLASS(this->lblCamera, UI::GUILabel(ui, this, this->env->GetLang(CSTR("ImageDetailCamera"))));
	...
	NEW_CLASS(this->lblFileTime, UI::GUILabel(ui, this, this->env->GetLang(CSTR("ImageDetailFileTime"))));
	...
	NEW_CLASS(this->lblLat, UI::GUILabel(ui, this, this->env->GetLang(CSTR("ImageDetailLat"))));
	this->lblLat->SetRect(0, 120, 100, 23, false);
	NEW_CLASS(this->txtLat, UI::GUITextBox(ui, this, CSTRP(sbuff, sptr)));
	this->txtLat->SetRect(100, 120, 150, 23, false);
	this->txtLat->SetReadOnly(true);
	sptr = Text::StrDouble(sbuff, userFile->lon);
	NEW_CLASS(this->lblLon, UI::GUILabel(ui, this, this->env->GetLang(CSTR("ImageDetailLon"))));
