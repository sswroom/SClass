...
SSWR::OrganMgr::OrganImageDetailForm::OrganImageDetailForm(UI::GUIClientControl *parent, UI::GUICore *ui, OrganEnv *env, UserFileInfo *userFile) : UI::GUIForm(parent, 420, 224, ui)
{
	...
	NEW_CLASS(this->txtId, UI::GUITextBox(ui, this, {sbuff, (UOSInt)(sptr - sbuff)}));
	...
	NEW_CLASS(this->txtFileTime, UI::GUITextBox(ui, this, {sbuff, (UOSInt)(sptr - sbuff)}));
	...
	NEW_CLASS(this->txtLat, UI::GUITextBox(ui, this, {sbuff, (UOSInt)(sptr - sbuff)}));
	...
	NEW_CLASS(this->txtLon, UI::GUITextBox(ui, this, {sbuff, (UOSInt)(sptr - sbuff)}));
