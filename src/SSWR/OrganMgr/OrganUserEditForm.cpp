...
SSWR::OrganMgr::OrganUserEditForm::OrganUserEditForm(UI::GUIClientControl *parent, UI::GUICore *ui, OrganEnv *env, OrganWebUser *user) : UI::GUIForm(parent, 480, 160, ui)
{
	...
	if (user)
	{
		this->SetText(this->env->GetLang((const UTF8Char*)"UserEditTitleModify"));
	}
	else
	{
		this->SetText(this->env->GetLang((const UTF8Char*)"UserEditTitleModify"));
	...
	NEW_CLASS(this->lblUserName, UI::GUILabel(ui, this, this->env->GetLang((const UTF8Char*)"UserEditUserName")));
	...
	NEW_CLASS(this->lblPassword, UI::GUILabel(ui, this, this->env->GetLang((const UTF8Char*)"UserEditPassword")));
	...
	NEW_CLASS(this->lblRetype, UI::GUILabel(ui, this, this->env->GetLang((const UTF8Char*)"UserEditRetype")));
	this->lblRetype->SetRect(64, 52, 100, 23, false);
	NEW_CLASS(this->txtRetype, UI::GUITextBox(ui, this, (const UTF8Char*)""));
	this->txtRetype->SetRect(164, 52, 200, 23, false);
	this->txtRetype->SetPasswordChar('*');
	NEW_CLASS(this->lblWatermark, UI::GUILabel(ui, this, this->env->GetLang((const UTF8Char*)"UserEditWatermark")));
	this->lblWatermark->SetRect(64, 76, 100, 23, false);
	NEW_CLASS(this->txtWatermark, UI::GUITextBox(ui, this, (const UTF8Char*)""));
	this->txtWatermark->SetRect(164, 76, 200, 23, false);
	NEW_CLASS(this->btnOK, UI::GUIButton(ui, this, this->env->GetLang((const UTF8Char*)"UserEditOk")));
	this->btnOK->SetRect(164, 108, 75, 23, false);
	this->btnOK->HandleButtonClick(OnOKClicked, this);
	NEW_CLASS(this->btnCancel, UI::GUIButton(ui, this, this->env->GetLang((const UTF8Char*)"UserEditCancel")));
