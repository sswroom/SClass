...
void __stdcall SSWR::OrganMgr::OrganSearchForm::OnOKClicked(void *userObj)
{
	...
	{
		UI::MessageDialog::ShowDialog(me->env->GetLang((const UTF8Char*)"SearchNotFound"), me->env->GetLang((const UTF8Char*)"SearchTitle"), me);
		me->txt->Focus();
	}
}
...
SSWR::OrganMgr::OrganSearchForm::OrganSearchForm(UI::GUIClientControl *parent, UI::GUICore *ui, OrganEnv *env) : UI::GUIForm(0, 340, 90, ui)
{
	...
	this->SetText(this->env->GetLang((const UTF8Char*)"SearchTitle"));

	NEW_CLASS(this->lbl, UI::GUILabel(ui, this, this->env->GetLang((const UTF8Char*)"SearchName")));
	lbl->SetRect(4, 6, 100, 21, false);
	NEW_CLASS(this->txt, UI::GUITextBox(ui, this, (const UTF8Char*)""));
	txt->SetRect(108, 6, 218, 23, false);
	NEW_CLASS(this->btnOK, UI::GUIButton(ui, this, this->env->GetLang((const UTF8Char*)"SearchButton")));
	this->btnOK->SetRect(76, 36, 75, 23, false);
	this->btnOK->HandleButtonClick(OnOKClicked, this);
	NEW_CLASS(this->btnCancel, UI::GUIButton(ui, this, this->env->GetLang((const UTF8Char*)"SearchCancel")));
