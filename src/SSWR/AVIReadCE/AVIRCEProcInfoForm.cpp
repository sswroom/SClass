...
SSWR::AVIReadCE::AVIRCEProcInfoForm::AVIRCEProcInfoForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, NotNullPtr<SSWR::AVIRead::AVIRCore> core) : UI::GUIForm(parent, 240, 320, ui)
{
	...
	NEW_CLASS(this->hspDetail = ui->NewHSplitter(this->tpDetail, 3, false));
	...
	NEW_CLASS(this->lblDetName, UI::GUILabel(ui, this->tpDetInfo, CSTR("Name")));
	...
	NEW_CLASS(this->lblDetPath, UI::GUILabel(ui, this->tpDetInfo, CSTR("Path")));
	...
	NEW_CLASS(this->hspDetHeap = ui->NewHSplitter(this->tpDetHeap, 3, false));
	...
	NEW_CLASS(this->vspDetChartCPU = ui->NewVSplitter(this->tpDetChart, 3, false));
	...
	NEW_CLASS(this->vspDetChartPage = ui->NewVSplitter(this->tpDetChart, 3, false));
	...
	NEW_CLASS(this->vspDetChartCount = ui->NewVSplitter(this->tpDetChart, 3, false));
