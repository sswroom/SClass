...
SSWR::AVIRead::AVIRProgramLinksForm::AVIRProgramLinksForm(UI::GUIClientControl *parent, UI::GUICore *ui, SSWR::AVIRead::AVIRCore *core) : UI::GUIForm(parent, 1024, 768, ui)
{
	...
	this->lblLinkName->SetRect(4, 4, 100, 23, false);
	NEW_CLASS(this->txtLinkName, UI::GUITextBox(ui, this->pnlItem, CSTR("")));
	this->txtLinkName->SetRect(104, 4, 500, 23, false);
	...
	this->txtType->SetRect(104, 28, 500, 23, false);
