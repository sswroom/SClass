...
SSWR::AVIRead::AVIRCustomTileMapForm::AVIRCustomTileMapForm(UI::GUIClientControl *parent, UI::GUICore *ui, SSWR::AVIRead::AVIRCore *core, Net::SSLEngine *ssl) : UI::GUIForm(parent, 1024, 120, ui)
{
