...
void __stdcall SSWR::AVIRead::AVIRImageGRForm::OnOKClicked(void *userObj)
{
	...
	{
		me->grFilter->ProcessImage32(me->srcImg->data, me->destImg->data, me->srcImg->info->dispWidth, me->srcImg->info->dispHeight, me->srcImg->info->storeWidth * (me->srcImg->info->storeBPP >> 3), me->destImg->info->storeWidth * (me->srcImg->info->storeBPP >> 3));
		me->previewCtrl->SetImage(me->destImg, true);
	}
	else if (me->srcImg->info->pf == Media::PF_LE_B16G16R16A16)
	{
		me->grFilter->ProcessImage64(me->srcImg->data, me->destImg->data, me->srcImg->info->dispWidth, me->srcImg->info->dispHeight, me->srcImg->info->storeWidth * (me->srcImg->info->storeBPP >> 3), me->destImg->info->storeWidth * (me->srcImg->info->storeBPP >> 3));
		me->previewCtrl->SetImage(me->destImg, true);
	}
...
void SSWR::AVIRead::AVIRImageGRForm::UpdatePreview()
{
	...
	{
		this->grFilter->ProcessImage32(this->srcPrevImg->data, this->destPrevImg->data, this->srcPrevImg->info->dispWidth, this->srcPrevImg->info->dispHeight, this->srcPrevImg->info->storeWidth * (this->srcPrevImg->info->storeBPP >> 3), this->destPrevImg->info->storeWidth * (this->srcPrevImg->info->storeBPP >> 3));
	}
	else if (this->srcPrevImg->info->pf == Media::PF_LE_B16G16R16A16)
	{
		this->grFilter->ProcessImage64(this->srcPrevImg->data, this->destPrevImg->data, this->srcPrevImg->info->dispWidth, this->srcPrevImg->info->dispHeight, this->srcPrevImg->info->storeWidth * (this->srcPrevImg->info->storeBPP >> 3), this->destPrevImg->info->storeWidth * (this->srcPrevImg->info->storeBPP >> 3));
	}
