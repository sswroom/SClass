...
SSWR::AVIRead::AVIRDNSClientForm::AVIRDNSClientForm(UI::GUIClientControl *parent, UI::GUICore *ui, SSWR::AVIRead::AVIRCore *core) : UI::GUIForm(parent, 1024, 768, ui)
{
	...
	NEW_CLASS(this->txtServer, UI::GUITextBox(ui, this->pnlRequest, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtRequest, UI::GUITextBox(ui, this->pnlRequest, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtRequestTime, UI::GUITextBox(ui, this->pnlRequest, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtAnsName, UI::GUITextBox(ui, this->pnlAnswer, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtAnsType, UI::GUITextBox(ui, this->pnlAnswer, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtAnsClass, UI::GUITextBox(ui, this->pnlAnswer, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtAnsTTL, UI::GUITextBox(ui, this->pnlAnswer, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtAnsRD, UI::GUITextBox(ui, this->pnlAnswer, (const UTF8Char*)""));
