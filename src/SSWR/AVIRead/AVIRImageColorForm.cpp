...
SSWR::AVIRead::AVIRImageColorForm::AVIRImageColorForm(UI::GUIClientControl *parent, UI::GUICore *ui, SSWR::AVIRead::AVIRCore *core, Media::StaticImage *srcImg, Media::StaticImage *destImg, UI::GUIPictureBoxDD *previewCtrl) : UI::GUIForm(parent, 640, 140, ui)
{
	...
	NEW_CLASS(this->lblBright, UI::GUILabel(ui, this, (const UTF8Char*)"Brightness"));
	...
	NEW_CLASS(this->lblBrightV, UI::GUILabel(ui, this, (const UTF8Char*)""));
	this->lblBrightV->SetRect(550, 0, 50, 24, false);
	NEW_CLASS(this->lblContr, UI::GUILabel(ui, this, (const UTF8Char*)"Contrast"));
	...
	NEW_CLASS(this->lblContrV, UI::GUILabel(ui, this, (const UTF8Char*)""));
	this->lblContrV->SetRect(550, 24, 50, 24, false);
	NEW_CLASS(this->lblGamma, UI::GUILabel(ui, this, (const UTF8Char*)"Gamma"));
