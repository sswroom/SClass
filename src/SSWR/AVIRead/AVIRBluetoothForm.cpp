...
void SSWR::AVIRead::AVIRBluetoothForm::UpdateDevList(BTStatus *btStatus)
{
	...
	while (i < j)
	{
		...
		this->lvDevice->SetSubItem(k, 2, (const UTF8Char*)mac->name);
...
SSWR::AVIRead::AVIRBluetoothForm::AVIRBluetoothForm(UI::GUIClientControl *parent, UI::GUICore *ui, SSWR::AVIRead::AVIRCore *core) : UI::GUIForm(parent, 1024, 768, ui)
{
	...
	NEW_CLASS(this->txtRadioName, UI::GUITextBox(ui, this->tpInfo, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtAddr, UI::GUITextBox(ui, this->tpInfo, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtManu, UI::GUITextBox(ui, this->tpInfo, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtSubver, UI::GUITextBox(ui, this->tpInfo, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtClass, UI::GUITextBox(ui, this->tpInfo, (const UTF8Char*)""));
