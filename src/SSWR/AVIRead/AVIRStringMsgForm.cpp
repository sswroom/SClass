...
SSWR::AVIRead::AVIRStringMsgForm::AVIRStringMsgForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, SSWR::AVIRead::AVIRCore *core, Text::CString title, Text::CString msg) : UI::GUIForm(parent, 480, 144, ui)
{
	this->SetText(title);
