...
SSWR::AVIRead::AVIRBTScanLogForm::AVIRBTScanLogForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, SSWR::AVIRead::AVIRCore *core, IO::BTScanLog *btLog) : UI::GUIForm(parent, 1024, 768, ui)
{
