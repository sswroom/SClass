...
SSWR::AVIRead::AVIRGooglePolylineForm::AVIRGooglePolylineForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, SSWR::AVIRead::AVIRCore *core) : UI::GUIForm(parent, 1024, 120, ui)
{
