...
SSWR::AVIRead::AVIRGISCombineForm::AVIRGISCombineForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, SSWR::AVIRead::AVIRCore *core, Data::ArrayList<Map::MapDrawLayer*> *layers) : UI::GUIForm(parent, 456, 300, ui)
{
	this->core = core;
