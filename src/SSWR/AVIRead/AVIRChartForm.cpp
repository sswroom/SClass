...
SSWR::AVIRead::AVIRChartForm::AVIRChartForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, SSWR::AVIRead::AVIRCore *core, Data::Chart *chart) : UI::GUIForm(parent, 1024, 768, ui)
{
