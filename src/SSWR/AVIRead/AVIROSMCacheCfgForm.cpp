...
void __stdcall SSWR::AVIRead::AVIROSMCacheCfgForm::OnOKClick(void *userObj)
{
	...
	case 0://MNU_OSM_TILE:
		...
		NEW_CLASS(hdlr, Map::OSM::OSMCacheHandler((const UTF8Char*)"http://a.tile.openstreetmap.org/", sbuff, 18, me->core->GetSocketFactory(), me->core->GetSSLEngine()));
	...
	case 1: //MNU_OSM_CYCLE:
		...
		NEW_CLASS(hdlr, Map::OSM::OSMCacheHandler((const UTF8Char*)"http://a.tile.thunderforest.com/cycle/", sbuff, 18, me->core->GetSocketFactory(), me->core->GetSSLEngine()));
	...
	case 2: //MNU_OSM_TRANSP:
		...
		NEW_CLASS(hdlr, Map::OSM::OSMCacheHandler((const UTF8Char*)"http://a.tile.thunderforest.com/transport/", sbuff, 18, me->core->GetSocketFactory(), me->core->GetSSLEngine()));
	...
	case 3: //MNU_OSM_MAPQUEST:
		...
		NEW_CLASS(hdlr, Map::OSM::OSMCacheHandler((const UTF8Char*)"http://otile1.mqcdn.com/tiles/1.0.0/osm/", sbuff, 18, me->core->GetSocketFactory(), me->core->GetSSLEngine()));
	...
	case 4: //MNU_OSM_LANDSCAPE:
		...
		NEW_CLASS(hdlr, Map::OSM::OSMCacheHandler((const UTF8Char*)"http://a.tile.thunderforest.com/landscape/", sbuff, 18, me->core->GetSocketFactory(), me->core->GetSSLEngine()));
	...
	case 5: //MNU_OSM_OUTDOORS:
		...
		NEW_CLASS(hdlr, Map::OSM::OSMCacheHandler((const UTF8Char*)"http://a.tile.thunderforest.com/outdoors/", sbuff, 18, me->core->GetSocketFactory(), me->core->GetSSLEngine()));
	...
	case 6: //MNU_OSM_TRANSP_DARK:
		...
		NEW_CLASS(hdlr, Map::OSM::OSMCacheHandler((const UTF8Char*)"http://a.tile.thunderforest.com/transport-dark/", sbuff, 18, me->core->GetSocketFactory(), me->core->GetSSLEngine()));
	...
	case 7: //MNU_OSM_SPINAL:
		...
		NEW_CLASS(hdlr, Map::OSM::OSMCacheHandler((const UTF8Char*)"http://a.tile.thunderforest.com/spinal-map/", sbuff, 18, me->core->GetSocketFactory(), me->core->GetSSLEngine()));
