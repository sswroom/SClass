...
void __stdcall SSWR::AVIRead::AVIRImageViewerForm::OnFileDrop(void *userObj, const UTF8Char **files, OSInt fileCnt)
{
...
void SSWR::AVIRead::AVIRImageViewerForm::EventMenuClicked(UInt16 cmdId)
{
	...
	case MNU_IMAGE_INFO:
		if (this->imgList) 
		{
			...
			sbTitle.Append((const UTF8Char*)"Image info for ");
