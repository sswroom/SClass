...
SSWR::AVIRead::AVIRSectorForm::AVIRSectorForm(Optional<UI::GUIClientControl> parent, NN<UI::GUICore> ui, NN<SSWR::AVIRead::AVIRCore> core, NN<IO::SectorData> data) : UI::GUIForm(parent, 1024, 768, ui)
{
	UTF8Char sbuff[512];
