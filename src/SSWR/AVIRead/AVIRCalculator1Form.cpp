...
SSWR::AVIRead::AVIRCalculator1Form::AVIRCalculator1Form(Optional<UI::GUIClientControl> parent, NN<UI::GUICore> ui, NN<SSWR::AVIRead::AVIRCore> core) : UI::GUIForm(parent, 412, 640, ui)
{
	UTF8Char sbuff[32];
	this->core = core;
