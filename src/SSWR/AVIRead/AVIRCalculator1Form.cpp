...
SSWR::AVIRead::AVIRCalculator1Form::AVIRCalculator1Form(UI::GUIClientControl *parent, UI::GUICore *ui, SSWR::AVIRead::AVIRCore *core) : UI::GUIForm(parent, 412, 640, ui)
{
	UTF8Char sbuff[32];
	this->core = core;

	this->SetFont(0, 22, false);
	this->SetText((const UTF8Char*)"Simple Calculator");
