...
SSWR::AVIRead::AVIRServiceForm::AVIRServiceForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, SSWR::AVIRead::AVIRCore *core) : UI::GUIForm(parent, 1024, 768, ui)
{
	...
	NEW_CLASS(this->btnEnable, UI::GUIButton(ui, this->pnlCtrl, CSTR("Enable")));
