...
void __stdcall SSWR::AVIRead::AVIRGISForm::OnReplayClosed(void *userObj, UI::GUIForm *frm)
{
	SSWR::AVIRead::AVIRGISForm *me = (SSWR::AVIRead::AVIRGISForm*)userObj;
	me->replayForm = 0;
}

void __stdcall SSWR::AVIRead::AVIRGISForm::OnEditImageClosed(void *userObj, UI::GUIForm *frm)
{
	SSWR::AVIRead::AVIRGISForm *me = (SSWR::AVIRead::AVIRGISForm*)userObj;
	me->editImageForm = 0;
}

void __stdcall SSWR::AVIRead::AVIRGISForm::OnTileDownClosed(void *userObj, UI::GUIForm *frm)
{
	SSWR::AVIRead::AVIRGISForm *me = (SSWR::AVIRead::AVIRGISForm*)userObj;
	me->tileDownForm = 0;
}

void __stdcall SSWR::AVIRead::AVIRGISForm::OnGPSSimClosed(void *userObj, UI::GUIForm *frm)
{
	SSWR::AVIRead::AVIRGISForm *me = (SSWR::AVIRead::AVIRGISForm*)userObj;
	me->gpsSimForm = 0;
}

void __stdcall SSWR::AVIRead::AVIRGISForm::OnQueryClosed(void *userObj, UI::GUIForm *frm)
{
	SSWR::AVIRead::AVIRGISForm *me = (SSWR::AVIRead::AVIRGISForm*)userObj;
	me->queryForm = 0;
}

void __stdcall SSWR::AVIRead::AVIRGISForm::OnGroupQueryClosed(void *userObj, UI::GUIForm *frm)
{
	SSWR::AVIRead::AVIRGISForm *me = (SSWR::AVIRead::AVIRGISForm*)userObj;
	me->groupQueryForm = 0;
}
...
void SSWR::AVIRead::AVIRGISForm::CloseCtrlForm()
{
	...
	if (this->editImageForm)
	{
		this->editImageForm->Close();
	}
	if (this->tileDownForm)
	{
		this->tileDownForm->Close();
	}
	if (this->gpsSimForm)
	{
		this->gpsSimForm->Close();
	}
	if (this->queryForm)
	{
	...
	if (this->groupQueryForm)
	{
		this->groupQueryForm->Close();
		this->SetSelectedVector(0);
	}
}
...
SSWR::AVIRead::AVIRGISForm::AVIRGISForm(UI::GUIClientControl *parent, UI::GUICore *ui, AVIRead::AVIRCore *core, Map::MapEnv *env, Map::MapView *view) : UI::GUIForm(parent, 1024, 768, ui)
{
	...
	this->replayForm = 0;
	this->editImageForm = 0;
	this->tileDownForm = 0;
	this->gpsSimForm = 0;
	this->queryForm = 0;
	this->groupQueryForm = 0;
	...
	UI::GUIMenu *mnu = this->mnuMain->AddSubMenu((const UTF8Char*)"&Map");
	mnu->AddItem((const UTF8Char*)"&Save", MNU_SAVE, UI::GUIMenu::KM_CONTROL, UI::GUIControl::GK_S);
	mnu->AddItem((const UTF8Char*)"&Copy Lat/Lon", MNU_COPY_LATLON, UI::GUIMenu::KM_CONTROL, UI::GUIControl::GK_L);
	mnu->AddItem((const UTF8Char*)"&Print...", MNU_PRINT, UI::GUIMenu::KM_CONTROL, UI::GUIControl::GK_P);
	mnu = this->mnuMain->AddSubMenu((const UTF8Char*)"&Add Layer");
	UI::GUIMenu *mnu2 = mnu->AddSubMenu((const UTF8Char*)"&MTK GPS Tracker");
	mnu2->AddItem((const UTF8Char*)"From &Device", MNU_MTK_GPS, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu2->AddItem((const UTF8Char*)"From &File", MNU_MTK_FILE, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu->AddItem((const UTF8Char*)"From Google Polyline String", MNU_GOOGLE_POLYLINE, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu->AddItem((const UTF8Char*)"From &File", MNU_OPEN_FILE, UI::GUIMenu::KM_CONTROL, UI::GUIControl::GK_O);
	mnu2 = mnu->AddSubMenu((const UTF8Char*)"HKO");
	UI::GUIMenu *mnu3 = mnu2->AddSubMenu((const UTF8Char*)"Radar");
	mnu3->AddItem((const UTF8Char*)"64km", MNU_HKO_RADAR_64, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu3->AddItem((const UTF8Char*)"128km", MNU_HKO_RADAR_128, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu3->AddItem((const UTF8Char*)"256km", MNU_HKO_RADAR_256, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu2->AddItem((const UTF8Char*)"Tropical Cyclone", MNU_HKO_CYCLONE, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu3 = mnu2->AddSubMenu((const UTF8Char*)"Current");
	mnu3->AddItem((const UTF8Char*)"Radar 64km", MNU_HKO_CURR_RADAR_64, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu3->AddItem((const UTF8Char*)"Radar 128km", MNU_HKO_CURR_RADAR_128, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu3->AddItem((const UTF8Char*)"Radar 256km", MNU_HKO_CURR_RADAR_256, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu3->AddItem((const UTF8Char*)"Satellite", MNU_HKO_CURR_SATELLITE, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu3->AddItem((const UTF8Char*)"Satellite (IR1-L1B-10)", MNU_HKO_CURR_SATELLITE_IR1_L1B_10, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu3->AddItem((const UTF8Char*)"Satellite (DC-10)", MNU_HKO_CURR_SATELLITE_DC_10, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu3->AddItem((const UTF8Char*)"Sand", MNU_HKO_CURR_SAND, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu3->AddItem((const UTF8Char*)"Weather Chart", MNU_HKO_CURR_WEATHER_CHART, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu2 = mnu->AddSubMenu((const UTF8Char*)"HKTD");
	mnu2->AddItem((const UTF8Char*)"Traffic", MNU_HKTD_TRAFFIC, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu2->AddItem((const UTF8Char*)"Tonnes Sign", MNU_HKTD_TONNES_SIGN, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu = this->mnuMain->AddSubMenu((const UTF8Char*)"&Device");
	mnu->AddItem((const UTF8Char*)"GPS Tracker", MNU_GPS_TRACKER, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu->AddItem((const UTF8Char*)"MTK GPS Tracker", MNU_MTKGPS_TRACKER, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu = this->mnuMain->AddSubMenu((const UTF8Char*)"&Tools");
	mnu->AddItem((const UTF8Char*)"GPS Simulator", MNU_GPS_SIMULATOR, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu->AddItem((const UTF8Char*)"Distance Tool", MNU_DISTANCE, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu->AddItem((const UTF8Char*)"Random Loc", MNU_RANDOMLOC, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->SetMenu(this->mnuMain);

	NEW_CLASS(this->mnuLayer, UI::GUIPopupMenu());
	this->mnuLayer->SetMenuForm(this);
	this->mnuLayer->AddItem((const UTF8Char*)"&Add Group", MNU_LAYER_ADD, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddItem((const UTF8Char*)"&Remove", MNU_LAYER_REMOVE, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddItem((const UTF8Char*)"Make Center", MNU_LAYER_CENTER, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddItem((const UTF8Char*)"Properties", MNU_LAYER_PROP, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddItem((const UTF8Char*)"Show Full Path", MNU_LAYER_PATH, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddItem((const UTF8Char*)"Search", MNU_LAYER_SEARCH, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddItem((const UTF8Char*)"Assign Coord Sys", MNU_LAYER_ASSIGN_CSYS, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddItem((const UTF8Char*)"Convert to Coord Sys", MNU_LAYER_CONV_CSYS, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddSeperator();
	this->mnuLayer->AddItem((const UTF8Char*)"&Save", MNU_LAYER_SAVE, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddItem((const UTF8Char*)"Combine Layer", MNU_LAYER_COMBINE, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddItem((const UTF8Char*)"Expand Layer", MNU_LAYER_EXPAND, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddItem((const UTF8Char*)"Convert to editable layer", MNU_LAYER_CONV, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddItem((const UTF8Char*)"Edit Layer", MNU_LAYER_EDIT, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddSeperator();
	this->mnuLayer->AddItem((const UTF8Char*)"Replay", MNU_LAYER_REPLAY, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddItem((const UTF8Char*)"Open DB", MNU_LAYER_OPENDB, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddItem((const UTF8Char*)"Tile Downloader", MNU_LAYER_TILEDOWN, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddItem((const UTF8Char*)"Import Tiles", MNU_LAYER_IMPORT_TILES, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddItem((const UTF8Char*)"Optimize File", MNU_LAYER_OPTIMIZE_FILE, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuLayer->AddItem((const UTF8Char*)"Query", MNU_LAYER_QUERY, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);

	NEW_CLASS(this->mnuGroup, UI::GUIPopupMenu());
	this->mnuGroup->AddItem((const UTF8Char*)"&Add Group", MNU_GROUP_ADD, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuGroup->AddItem((const UTF8Char*)"&Remove", MNU_GROUP_REMOVE, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuGroup->SetMenuForm(this);
	mnu = this->mnuGroup->AddSubMenu((const UTF8Char*)"&New Layer");
	mnu->AddItem((const UTF8Char*)"&Point Layer", MNU_GROUP_NEW_POINT, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu->AddItem((const UTF8Char*)"Poly&line Layer", MNU_GROUP_NEW_POLYLINE, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu->AddItem((const UTF8Char*)"Poly&gon Layer", MNU_GROUP_NEW_POLYGON, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	mnu->AddItem((const UTF8Char*)"&Image Layer", MNU_GROUP_NEW_IMAGE, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuGroup->AddItem((const UTF8Char*)"Make &Center", MNU_GROUP_CENTER, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
	this->mnuGroup->AddItem((const UTF8Char*)"Query", MNU_GROUP_QUERY, UI::GUIMenu::KM_NONE, UI::GUIControl::GK_NONE);
...
//				DEL_CLASS(printer);
	...
	case MNU_GROUP_NEW_IMAGE:
		{
			...
			NEW_CLASS(layer, Map::VectorLayer(Map::DRAW_LAYER_IMAGE, (const UTF8Char*)"Image Layer", 1, &cols, this->env->GetCoordinateSystem()->Clone(), 0, 0));
	...
	case MNU_GROUP_NEW_POINT:
		{
			...
			Map::VectorLayer *layer;
			const UTF8Char *cols = (const UTF8Char*)"Name";
			NEW_CLASS(layer, Map::VectorLayer(Map::DRAW_LAYER_POINT, (const UTF8Char*)"Point Layer", 1, &cols, this->env->GetCoordinateSystem()->Clone(), 0, 0));
			this->env->AddLayer((Map::MapEnv::GroupItem*)ind->item, layer, true);
			layer->AddUpdatedHandler(OnMapLayerUpdated, this);
			this->mapTree->UpdateTree();
		}
	...
	case MNU_GROUP_NEW_POLYLINE:
		{
			...
			Map::VectorLayer *layer;
			const UTF8Char *cols = (const UTF8Char*)"Name";
			NEW_CLASS(layer, Map::VectorLayer(Map::DRAW_LAYER_POLYLINE, (const UTF8Char*)"Polyline Layer", 1, &cols, this->env->GetCoordinateSystem()->Clone(), 0, 0));
			this->env->AddLayer((Map::MapEnv::GroupItem*)ind->item, layer, true);
			layer->AddUpdatedHandler(OnMapLayerUpdated, this);
			this->mapTree->UpdateTree();
		}
	...
	case MNU_GROUP_NEW_POLYGON:
		{
			...
			Map::VectorLayer *layer;
			const UTF8Char *cols = (const UTF8Char*)"Name";
			NEW_CLASS(layer, Map::VectorLayer(Map::DRAW_LAYER_POLYGON, (const UTF8Char*)"Polygon Layer", 1, &cols, this->env->GetCoordinateSystem()->Clone(), 0, 0));
			this->env->AddLayer((Map::MapEnv::GroupItem*)ind->item, layer, true);
			layer->AddUpdatedHandler(OnMapLayerUpdated, this);
			this->mapTree->UpdateTree();
		}
	...
	case MNU_GROUP_QUERY:
		{
			UI::GUIMapTreeView::ItemIndex *ind = (UI::GUIMapTreeView::ItemIndex*)this->popNode->GetItemObj();
			this->CloseCtrlForm();
			NEW_CLASS(this->groupQueryForm, SSWR::AVIRead::AVIRGISGroupQueryForm(0, this->ui, this->core, this, this->env, (Map::MapEnv::GroupItem*)ind->item));
			this->groupQueryForm->HandleFormClosed(OnGroupQueryClosed, this);
			this->groupQueryForm->Show();
		}
		break;
	case MNU_LAYER_ADD:
		{
	...
	case MNU_LAYER_SEARCH:
		{
			...
			if (searching)
			{
				AVIRGISSearchForm *frm;
				NEW_CLASS(frm, AVIRGISSearchForm(0, ui, this->core, this, layer->layer, searching, setting.labelCol, setting.flags));
	...
	case MNU_LAYER_EDIT:
		{
			...
			{
				this->CloseCtrlForm();
				NEW_CLASS(this->editImageForm, SSWR::AVIRead::AVIRGISEditImageForm(0, this->ui, this->core, (Map::VectorLayer*)lyr, this));
				this->editImageForm->HandleFormClosed(OnEditImageClosed, this);
				this->editImageForm->Show();
			}
		}
		break;
	case MNU_LAYER_REPLAY:
		{
			this->CloseCtrlForm();
			NEW_CLASS(this->replayForm, SSWR::AVIRead::AVIRGISReplayForm(0, this->ui, this->core, (Map::GPSTrack*)((Map::MapEnv::LayerItem*)((UI::GUIMapTreeView::ItemIndex*)this->popNode->GetItemObj())->item)->layer, this));
			this->replayForm->HandleFormClosed(OnReplayClosed, this);
	...
	case MNU_LAYER_OPENDB:
		{
			Map::IMapDrawLayer *lyr = ((Map::MapEnv::LayerItem*)((UI::GUIMapTreeView::ItemIndex*)this->popNode->GetItemObj())->item)->layer;
			AVIRDBForm *frm;
			NEW_CLASS(frm, AVIRDBForm(0, ui, this->core, lyr, false));
			frm->HandleFormClosed(OnSubFormClosed, this);
			this->subForms->Add(frm);
			frm->Show();
		}
	...
	case MNU_LAYER_TILEDOWN:
		{
			...
			{
				this->CloseCtrlForm();
				NEW_CLASS(this->tileDownForm, SSWR::AVIRead::AVIRGISTileDownloadForm(0, this->ui, this->core, (Map::TileMapLayer*)lyr, this));
				this->tileDownForm->HandleFormClosed(OnTileDownClosed, this);
				this->tileDownForm->Show();
			}
		}
		break;
			...
			if (lyr->GetObjectClass() == Map::IMapDrawLayer::OC_TILE_MAP_LAYER)
			{
				...
				if (tileMap->GetTileType() == Map::TileMap::TT_OSM)
				{
					...
					if (osm->HasSPackageFile())
					{
						...
						if (dlg->ShowDialog(this->GetHandle()))
						{
							osm->OptimizeToFile(dlg->GetFileName());
						}
						DEL_CLASS(dlg);
					}
				}
	...
	case MNU_LAYER_QUERY:
		{
			Map::IMapDrawLayer *lyr = ((Map::MapEnv::LayerItem*)((UI::GUIMapTreeView::ItemIndex*)this->popNode->GetItemObj())->item)->layer;
			this->CloseCtrlForm();
			NEW_CLASS(this->queryForm, SSWR::AVIRead::AVIRGISQueryForm(0, this->ui, this->core, lyr, this));
			this->queryForm->HandleFormClosed(OnQueryClosed, this);
			this->queryForm->Show();
		}
		break;
	case MNU_MTK_GPS:
	...
	case MNU_GPS_TRACKER:
		{
			...
			if (frm->ShowDialog(this) == UI::GUIForm::DR_OK)
			{
				...
				NEW_CLASS(trk, Map::GPSTrack((const UTF8Char*)"GPS_Tracker", true, 0, 0));
	...
	case MNU_MTKGPS_TRACKER:
		{
			...
			if (frm->ShowDialog(this) == UI::GUIForm::DR_OK)
			{
				...
				NEW_CLASS(gpsFrm, SSWR::AVIRead::AVIRGPSTrackerForm(0, this->ui, this->core, gps, true));
				this->AddSubForm(gpsFrm);
				NEW_CLASS(trk, Map::GPSTrack((const UTF8Char*)"MTK_GPS_Tracker", true, 0, 0));
				gpsFrm->SetGPSTrack(trk);
				gpsFrm->SetMapNavigator(this);
				this->AddLayer(trk);
			}
	...
	case MNU_GPS_SIMULATOR:
		this->CloseCtrlForm();
		NEW_CLASS(this->gpsSimForm, SSWR::AVIRead::AVIRGPSSimulatorForm(0, this->ui, this->core, this));
		this->gpsSimForm->HandleFormClosed(OnGPSSimClosed, this);
		this->gpsSimForm->Show();
		break;
	case MNU_DISTANCE:
		{
			SSWR::AVIRead::AVIRGISDistanceForm *frm;
			NEW_CLASS(frm, SSWR::AVIRead::AVIRGISDistanceForm(0, this->ui, this->core, this));
			this->subForms->Add(frm);
			frm->HandleFormClosed(OnSubFormClosed, this);
			frm->Show();
		}
	...
	case MNU_RANDOMLOC:
		{
			SSWR::AVIRead::AVIRGISRandomLocForm *frm;
			NEW_CLASS(frm, SSWR::AVIRead::AVIRGISRandomLocForm(0, this->ui, this->core, this));
			this->subForms->Add(frm);
			frm->HandleFormClosed(OnSubFormClosed, this);
			frm->Show();
		}
