...
SSWR::AVIRead::AVIROSMCacheForm::AVIROSMCacheForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, NotNullPtr<SSWR::AVIRead::AVIRCore> core, Net::WebServer::WebListener *listener, Map::OSM::OSMCacheHandler *hdlr) : UI::GUIForm(parent, 1024, 768, ui)
{
