...
SSWR::AVIRead::AVIRColorCustomForm::AVIRColorCustomForm(UI::GUIClientControl *parent, UI::GUICore *ui, SSWR::AVIRead::AVIRCore *core, Media::MonitorColorManager *monColor) : UI::GUIForm(parent, 640, 480, ui)
{
	...
	sptr = Text::StrDouble(sbuff, rgbParam->monProfile->GetPrimaries()->rx);
	this->txtRX->SetText(CSTRP(sbuff, sptr));
	sptr = Text::StrDouble(sbuff, rgbParam->monProfile->GetPrimaries()->ry);
	this->txtRY->SetText(CSTRP(sbuff, sptr));
	sptr = Text::StrDouble(sbuff, rgbParam->monProfile->GetPrimaries()->gx);
	this->txtGX->SetText(CSTRP(sbuff, sptr));
	sptr = Text::StrDouble(sbuff, rgbParam->monProfile->GetPrimaries()->gy);
	this->txtGY->SetText(CSTRP(sbuff, sptr));
	sptr = Text::StrDouble(sbuff, rgbParam->monProfile->GetPrimaries()->bx);
	this->txtBX->SetText(CSTRP(sbuff, sptr));
	sptr = Text::StrDouble(sbuff, rgbParam->monProfile->GetPrimaries()->by);
	this->txtBY->SetText(CSTRP(sbuff, sptr));
	sptr = Text::StrDouble(sbuff, rgbParam->monProfile->GetPrimaries()->wx);
	this->txtWX->SetText(CSTRP(sbuff, sptr));
	sptr = Text::StrDouble(sbuff, rgbParam->monProfile->GetPrimaries()->wy);
