...
SSWR::AVIRead::AVIRHexViewerForm::AVIRHexViewerForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, SSWR::AVIRead::AVIRCore *core) : UI::GUIForm(parent, 800, 600, ui)
{
...
void SSWR::AVIRead::AVIRHexViewerForm::SetData(IO::StreamData *fd, IO::FileAnalyse::IFileAnalyse *fileAnalyse)
{
