...
SSWR::AVIRead::AVIRHexViewerForm::AVIRHexViewerForm(UI::GUIClientControl *parent, UI::GUICore *ui, SSWR::AVIRead::AVIRCore *core) : UI::GUIForm(parent, 800, 600, ui)
{
	...
	NEW_CLASS(this->radEndianLittle, UI::GUIRadioButton(ui, this->pnlValues, (const UTF8Char*)"Little Endian", true));
	this->radEndianLittle->SetRect(104, 4, 150, 23, false);
	NEW_CLASS(this->radEndianBig, UI::GUIRadioButton(ui, this->pnlValues, (const UTF8Char*)"Big Endian", false));
	this->radEndianBig->SetRect(254, 4, 150, 23, false);
	this->radEndianBig->HandleSelectedChange(OnEndianChg, this);
	NEW_CLASS(this->lblInt8, UI::GUILabel(ui, this->pnlValues, (const UTF8Char*)"Int8"));
	this->lblInt8->SetRect(4, 28, 100, 23, false);
	NEW_CLASS(this->txtInt8, UI::GUITextBox(ui, this->pnlValues, (const UTF8Char*)""));
	this->txtInt8->SetRect(104, 28, 150, 23, false);
	this->txtInt8->SetReadOnly(true);
	NEW_CLASS(this->lblInt16, UI::GUILabel(ui, this->pnlValues, (const UTF8Char*)"Int16"));
	this->lblInt16->SetRect(4, 52, 100, 23, false);
	NEW_CLASS(this->txtInt16, UI::GUITextBox(ui, this->pnlValues, (const UTF8Char*)""));
	this->txtInt16->SetRect(104, 52, 150, 23, false);
	this->txtInt16->SetReadOnly(true);
	NEW_CLASS(this->lblInt32, UI::GUILabel(ui, this->pnlValues, (const UTF8Char*)"Int32"));
	this->lblInt32->SetRect(4, 76, 100, 23, false);
	NEW_CLASS(this->txtInt32, UI::GUITextBox(ui, this->pnlValues, (const UTF8Char*)""));
	this->txtInt32->SetRect(104, 76, 150, 23, false);
	this->txtInt32->SetReadOnly(true);
	NEW_CLASS(this->lblInt64, UI::GUILabel(ui, this->pnlValues, (const UTF8Char*)"Int64"));
	this->lblInt64->SetRect(4, 100, 100, 23, false);
	NEW_CLASS(this->txtInt64, UI::GUITextBox(ui, this->pnlValues, (const UTF8Char*)""));
	this->txtInt64->SetRect(104, 100, 150, 23, false);
	this->txtInt64->SetReadOnly(true);
	NEW_CLASS(this->lblUInt8, UI::GUILabel(ui, this->pnlValues, (const UTF8Char*)"UInt8"));
	this->lblUInt8->SetRect(254, 28, 100, 23, false);
	NEW_CLASS(this->txtUInt8, UI::GUITextBox(ui, this->pnlValues, (const UTF8Char*)""));
	this->txtUInt8->SetRect(354, 28, 150, 23, false);
	this->txtUInt8->SetReadOnly(true);
	NEW_CLASS(this->lblUInt16, UI::GUILabel(ui, this->pnlValues, (const UTF8Char*)"UInt16"));
	this->lblUInt16->SetRect(254, 52, 100, 23, false);
	NEW_CLASS(this->txtUInt16, UI::GUITextBox(ui, this->pnlValues, (const UTF8Char*)""));
	this->txtUInt16->SetRect(354, 52, 150, 23, false);
	this->txtUInt16->SetReadOnly(true);
	NEW_CLASS(this->lblUInt32, UI::GUILabel(ui, this->pnlValues, (const UTF8Char*)"UInt32"));
	this->lblUInt32->SetRect(254, 76, 100, 23, false);
	NEW_CLASS(this->txtUInt32, UI::GUITextBox(ui, this->pnlValues, (const UTF8Char*)""));
	this->txtUInt32->SetRect(354, 76, 150, 23, false);
	this->txtUInt32->SetReadOnly(true);
	NEW_CLASS(this->lblUInt64, UI::GUILabel(ui, this->pnlValues, (const UTF8Char*)"UInt64"));
	this->lblUInt64->SetRect(254, 100, 100, 23, false);
	NEW_CLASS(this->txtUInt64, UI::GUITextBox(ui, this->pnlValues, (const UTF8Char*)""));
	this->txtUInt64->SetRect(354, 100, 150, 23, false);
	this->txtUInt64->SetReadOnly(true);
	NEW_CLASS(this->lblFloat32, UI::GUILabel(ui, this->pnlValues, (const UTF8Char*)"Float32"));
	this->lblFloat32->SetRect(504, 28, 100, 23, false);
	NEW_CLASS(this->txtFloat32, UI::GUITextBox(ui, this->pnlValues, (const UTF8Char*)""));
	this->txtFloat32->SetRect(604, 28, 150, 23, false);
	this->txtFloat32->SetReadOnly(true);
	NEW_CLASS(this->lblFloat64, UI::GUILabel(ui, this->pnlValues, (const UTF8Char*)"Float64"));
