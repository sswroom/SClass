...
void __stdcall SSWR::AVIRead::AVIRGPSTrackerForm::OnMTKLogDownloadClicked(void *userObj)
{
	...
	{
		Map::GPSTrack *gpsTrk;
		NEW_CLASS(gpsTrk, Map::GPSTrack((const UTF8Char*)"MTK_GPS", true, 0, 0));
...
SSWR::AVIRead::AVIRGPSTrackerForm::AVIRGPSTrackerForm(UI::GUIClientControl *parent, UI::GUICore *ui, SSWR::AVIRead::AVIRCore *core, Map::ILocationService *locSvc, Bool toRelease) : UI::GUIForm(parent, 340, 348, ui)
{
	...
	NEW_CLASS(this->txtGPSTime, UI::GUITextBox(ui, this->tpLocation, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtLatitude, UI::GUITextBox(ui, this->tpLocation, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtLongitude, UI::GUITextBox(ui, this->tpLocation, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtAltitude, UI::GUITextBox(ui, this->tpLocation, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtSpeed, UI::GUITextBox(ui, this->tpLocation, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtHeading, UI::GUITextBox(ui, this->tpLocation, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtGPSValid, UI::GUITextBox(ui, this->tpLocation, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtNSateUsed, UI::GUITextBox(ui, this->tpLocation, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtNSateView, UI::GUITextBox(ui, this->tpLocation, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtDistance, UI::GUITextBox(ui, this->tpLocation, (const UTF8Char*)""));
	...
	if (this->locSvc->GetServiceType() == Map::ILocationService::ST_MTK)
	{
		...
		NEW_CLASS(this->txtMTKRelease, UI::GUITextBox(ui, this->grpMTKFirmware, (const UTF8Char*)""));
		...
		NEW_CLASS(this->txtMTKBuildID, UI::GUITextBox(ui, this->grpMTKFirmware, (const UTF8Char*)""));
		...
		NEW_CLASS(this->txtMTKProdMode, UI::GUITextBox(ui, this->grpMTKFirmware, (const UTF8Char*)""));
		...
		NEW_CLASS(this->txtMTKSDKVer, UI::GUITextBox(ui, this->grpMTKFirmware, (const UTF8Char*)""));
