...
SSWR::AVIRead::AVIRSystemInfoLogForm::AVIRSystemInfoLogForm(UI::GUIClientControl *parent, UI::GUICore *ui, SSWR::AVIRead::AVIRCore *core, IO::SystemInfoLog *sysInfo) : UI::GUIForm(parent, 800, 600, ui)
{
	...
	NEW_CLASS(this->txtOSName, UI::GUITextBox(ui, this->tpSystem, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtOSVer, UI::GUITextBox(ui, this->tpSystem, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtOSLocale, UI::GUITextBox(ui, this->tpSystem, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtArchitecture, UI::GUITextBox(ui, this->tpSystem, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtProductType, UI::GUITextBox(ui, this->tpSystem, (const UTF8Char*)""));
