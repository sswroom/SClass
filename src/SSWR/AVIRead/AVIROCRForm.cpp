...
SSWR::AVIRead::AVIROCRForm::AVIROCRForm(UI::GUIClientControl *parent, UI::GUICore *ui, SSWR::AVIRead::AVIRCore *core) : UI::GUIForm(parent, 1024, 768, ui), ocr(Media::OCREngine::Language::English)
{
	...
	NEW_CLASS(this->lvText, UI::GUIListView(ui, this->pnlResult, UI::GUIListView::LVSTYLE_TABLE, 4));
