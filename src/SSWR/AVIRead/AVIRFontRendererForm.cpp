...
SSWR::AVIRead::AVIRFontRendererForm::AVIRFontRendererForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, SSWR::AVIRead::AVIRCore *core, Media::FontRenderer *font) : UI::GUIForm(parent, 1024, 768, ui)
{
	UTF8Char sbuff[32];
	UTF8Char *sptr;
