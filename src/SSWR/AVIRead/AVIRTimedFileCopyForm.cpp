					...
					{
						{
							...
							else
							{
								...
								succ = zip->AddFile(CSTRP(pathBase, UnsafeArray<const UTF8Char>(sptr)), fs, modTime, accTime, createTime, Data::Compress::Deflater::CompLevel::BestCompression, unixAttr);
