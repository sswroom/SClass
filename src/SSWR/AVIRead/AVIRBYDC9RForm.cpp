...
SSWR::AVIRead::AVIRBYDC9RForm::AVIRBYDC9RForm(UI::GUIClientControl *parent, UI::GUICore *ui, SSWR::AVIRead::AVIRCore *core) : UI::GUIForm(parent, 1024, 768, ui)
{
	...
	NEW_CLASS(this->grpCANBus, UI::GUIGroupBox(ui, this, CSTR("CAN Bus")));
	...
	NEW_CLASS(this->lblSpeedKmHr, UI::GUILabel(ui, this, CSTR("Speed (km/Hr)")));
	...
	NEW_CLASS(this->lblDoor1, UI::GUILabel(ui, this, CSTR("Door1")));
	...
	NEW_CLASS(this->lblDoor2, UI::GUILabel(ui, this, CSTR("Door2")));
	...
	NEW_CLASS(this->lblBatteryLevel, UI::GUILabel(ui, this, CSTR("Battery Level (%)")));
	...
	NEW_CLASS(this->lblMotorRPM, UI::GUILabel(ui, this, CSTR("Motor RPM")));
	...
	NEW_CLASS(this->lblBatteryStartCharging, UI::GUILabel(ui, this, CSTR("Battery Start Charging")));
	...
	NEW_CLASS(this->lblLeftMotorMode, UI::GUILabel(ui, this, CSTR("Left Motor Mode")));
	...
	NEW_CLASS(this->lblRightotorMode, UI::GUILabel(ui, this, CSTR("Left Motor Mode")));
	...
	NEW_CLASS(this->lblCarbinDoorBack, UI::GUILabel(ui, this, CSTR("Carbin Door Back")));
	...
	NEW_CLASS(this->lblCarbinDoorLeft, UI::GUILabel(ui, this, CSTR("Carbin Door Left")));
	...
	NEW_CLASS(this->lblCarbinDoorRight, UI::GUILabel(ui, this, CSTR("Carbin Door Right")));
	...
	NEW_CLASS(this->lblPowerMode, UI::GUILabel(ui, this, CSTR("Power Mode")));
	...
	NEW_CLASS(this->lblBatteryCharging, UI::GUILabel(ui, this, CSTR("Battery Charging")));
	...
	NEW_CLASS(this->lblOkLED, UI::GUILabel(ui, this, CSTR("Ok LED")));
