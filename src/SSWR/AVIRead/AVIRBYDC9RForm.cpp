...
SSWR::AVIRead::AVIRBYDC9RForm::AVIRBYDC9RForm(Optional<UI::GUIClientControl> parent, NotNullPtr<UI::GUICore> ui, NotNullPtr<SSWR::AVIRead::AVIRCore> core) : UI::GUIForm(parent, 1024, 768, ui)
{
	...
	this->txtCANBus = ui->NewTextBox(this->grpCANBus, CSTR(""));
	...
	this->txtDoor1 = ui->NewTextBox(*this, IO::Device::BYDC9RHandler::DoorStatusGetName(this->dispStatus.door1));
	...
	this->txtDoor2 = ui->NewTextBox(*this, IO::Device::BYDC9RHandler::DoorStatusGetName(this->dispStatus.door2));
	...
	this->txtBatteryLevel = ui->NewTextBox(*this, CSTR("0"));
	...
	this->txtMotorRPM = ui->NewTextBox(*this, CSTR("0"));
	...
	this->txtBatteryStartCharging = ui->NewTextBox(*this, CSTRP(sbuff, sptr));
	...
	this->txtLeftMotorMode = ui->NewTextBox(*this, IO::Device::BYDC9RHandler::MotorModeGetName(this->dispStatus.leftMotorMode));
	...
	this->txtRightMotorMode = ui->NewTextBox(*this, IO::Device::BYDC9RHandler::MotorModeGetName(this->dispStatus.rightMotorMode));
	...
	this->txtCarbinDoorBack = ui->NewTextBox(*this, CSTR("false"));
	...
	this->txtCarbinDoorLeft = ui->NewTextBox(*this, CSTR("false"));
	...
	this->txtCarbinDoorRight = ui->NewTextBox(*this, CSTR("false"));
	...
	this->txtPowerMode = ui->NewTextBox(*this, IO::Device::BYDC9RHandler::PowerStatusGetName(this->dispStatus.powerMode));
	...
	this->txtBatteryCharging = ui->NewTextBox(*this, IO::Device::BYDC9RHandler::ChargingStatusGetName(this->dispStatus.batteryCharging));
	...
	this->txtOkLED = ui->NewTextBox(*this, CSTR("false"));
