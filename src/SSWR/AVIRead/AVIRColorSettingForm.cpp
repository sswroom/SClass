...
SSWR::AVIRead::AVIRColorSettingForm::AVIRColorSettingForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, SSWR::AVIRead::AVIRCore *core, MonitorHandle *hMon) : UI::GUIForm(parent, 640, 480, ui)
{
