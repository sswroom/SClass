...
SSWR::AVIRead::AVIRHexViewerGoToForm::AVIRHexViewerGoToForm(UI::GUIClientControl *parent, UI::GUICore *ui, SSWR::AVIRead::AVIRCore *core, UInt64 currOfst, UInt64 fileSize) : UI::GUIForm(parent, 320, 160, ui)
{
	this->core = core;
