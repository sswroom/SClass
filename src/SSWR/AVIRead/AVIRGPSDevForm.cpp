...
void __stdcall SSWR::AVIRead::AVIRGPSDevForm::OnTimerTick(void *userObj)
{
	...
	if (me->devContUpd)
	{
		...
		me->devContMut->Unlock();
	}
	if (me->alertContUpd)
	{
		me->alertContUpd = false;
		me->alertContMut->Lock();
