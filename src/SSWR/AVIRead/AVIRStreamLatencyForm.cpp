...
{
	this->SetText((const UTF8Char*)"Stream Latency");
	...
	this->cboReqInterval->AddItem((const UTF8Char*)"1s", (void *)1000);
	this->cboReqInterval->AddItem((const UTF8Char*)"2s", (void *)2000);
	this->cboReqInterval->AddItem((const UTF8Char*)"3s", (void *)3000);
	this->cboReqInterval->AddItem((const UTF8Char*)"4s", (void *)4000);
	this->cboReqInterval->AddItem((const UTF8Char*)"5s", (void *)5000);
	this->cboReqInterval->AddItem((const UTF8Char*)"10s", (void *)10000);
	this->cboReqInterval->AddItem((const UTF8Char*)"15s", (void *)15000);
	this->cboReqInterval->AddItem((const UTF8Char*)"20s", (void *)20000);
	this->cboReqInterval->AddItem((const UTF8Char*)"30s", (void *)30000);
	this->cboReqInterval->AddItem((const UTF8Char*)"45s", (void *)45000);
	this->cboReqInterval->AddItem((const UTF8Char*)"1min", (void *)60000);
	this->cboReqInterval->AddItem((const UTF8Char*)"2min", (void *)120000);
