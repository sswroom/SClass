...
SSWR::AVIRead::AVIRCertUtilForm::AVIRCertUtilForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, NotNullPtr<SSWR::AVIRead::AVIRCore> core) : UI::GUIForm(parent, 1024, 768, ui)
{
	...
	NEW_CLASS(this->lblCountryName2, UI::GUILabel(ui, this, CSTR("Country Name (2 Chars)")));
	...
	NEW_CLASS(this->lblStateOrProvinceName2, UI::GUILabel(ui, this, CSTR("State Or Province Name")));
	...
	NEW_CLASS(this->lblLocalityName2, UI::GUILabel(ui, this, CSTR("Locality Name")));
	...
	NEW_CLASS(this->lblOrganizationName2, UI::GUILabel(ui, this, CSTR("Organization Name")));
	...
	NEW_CLASS(this->lblOrganizationUnitName2, UI::GUILabel(ui, this, CSTR("Organization Unit Name")));
	...
	NEW_CLASS(this->lblCommonName2, UI::GUILabel(ui, this, CSTR("Common Name")));
