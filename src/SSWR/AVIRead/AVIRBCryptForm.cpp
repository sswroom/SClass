...
SSWR::AVIRead::AVIRBCryptForm::AVIRBCryptForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, SSWR::AVIRead::AVIRCore *core) : UI::GUIForm(parent, 800, 320, ui)
{
	...
	NEW_CLASS(this->grpGenerate, UI::GUIGroupBox(ui, this, CSTR("Generate")));
	...
	NEW_CLASS(this->lblGenPassword, UI::GUILabel(ui, this->grpGenerate, CSTR("Password")));
	...
	NEW_CLASS(this->grpCheck, UI::GUIGroupBox(ui, this, CSTR("Check")));
	...
	NEW_CLASS(this->lblCheckPassword, UI::GUILabel(ui, this->grpCheck, CSTR("Password")));
