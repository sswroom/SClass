...
SSWR::AVIRead::AVIROpenFileForm::AVIROpenFileForm(UI::GUIClientControl *parent, UI::GUICore *ui, SSWR::AVIRead::AVIRCore *core, IO::ParsedObject::ParserType t) : UI::GUIForm(parent, 640, 120, ui)
{
