...
SSWR::AVIRead::AVIRRSSItemForm::AVIRRSSItemForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, SSWR::AVIRead::AVIRCore *core, Net::RSSItem *rssItem) : UI::GUIForm(parent, 1024, 768, ui)
{
	UOSInt i;
	UOSInt j;
	UTF8Char sbuff[128];
