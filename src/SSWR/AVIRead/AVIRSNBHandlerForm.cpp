...
SSWR::AVIRead::AVIRSNBHandlerForm::AVIRSNBHandlerForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, SSWR::AVIRead::AVIRCore *core, IO::SNBDongle::HandleType handType) : UI::GUIForm(parent, 1024, 768, ui)
{
