...
SSWR::AVIRead::AVIRUDPTestForm::AVIRUDPTestForm(UI::GUIClientControl *parent, NotNullPtr<UI::GUICore> ui, NotNullPtr<SSWR::AVIRead::AVIRCore> core) : UI::GUIForm(parent, 1024, 384, ui)
{
	...
	NEW_CLASS(this->txtSentFailCntRate, UI::GUITextBox(ui, this->grpStatus, CSTR("")));
