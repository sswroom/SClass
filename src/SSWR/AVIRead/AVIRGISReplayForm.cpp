...
SSWR::AVIRead::AVIRGISReplayForm::AVIRGISReplayForm(UI::GUIClientControl *parent, UI::GUICore *ui, SSWR::AVIRead::AVIRCore *core, Map::GPSTrack *track, IMapNavigator *navi) : UI::GUIForm(parent, 416, 560, ui)
{
	...
	lbl->SetRect(0, 0, 100, 23, false);
	NEW_CLASS(this->txtStartMark, UI::GUITextBox(ui, pnl, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtEndMark, UI::GUITextBox(ui, pnl, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtGPSTime, UI::GUITextBox(ui, pnl, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtLatitude, UI::GUITextBox(ui, pnl, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtLongitude, UI::GUITextBox(ui, pnl, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtAltitude, UI::GUITextBox(ui, pnl, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtSpeedKnot, UI::GUITextBox(ui, pnl, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtSpeedKM, UI::GUITextBox(ui, pnl, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtHeading, UI::GUITextBox(ui, pnl, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtValid, UI::GUITextBox(ui, pnl, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtNSateView, UI::GUITextBox(ui, pnl, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtNSateUsed, UI::GUITextBox(ui, pnl, (const UTF8Char*)""));
	...
	NEW_CLASS(this->txtAddress, UI::GUITextBox(ui, pnl, (const UTF8Char*)""));
