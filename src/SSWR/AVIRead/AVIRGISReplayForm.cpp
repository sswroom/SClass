...
SSWR::AVIRead::AVIRGISReplayForm::AVIRGISReplayForm(UI::GUIClientControl *parent, UI::GUICore *ui, SSWR::AVIRead::AVIRCore *core, Map::GPSTrack *track, IMapNavigator *navi) : UI::GUIForm(parent, 416, 560, ui)
{
	...
	NEW_CLASS(lbl, UI::GUILabel(ui, pnl, CSTR("Start Mark")));
	lbl->SetRect(0, 0, 100, 23, false);
	...
	NEW_CLASS(lbl, UI::GUILabel(ui, pnl, CSTR("End Mark")));
	...
	NEW_CLASS(lbl, UI::GUILabel(ui, pnl, CSTR("GPS Time")));
	...
	NEW_CLASS(lbl, UI::GUILabel(ui, pnl, CSTR("Latitude")));
	...
	NEW_CLASS(lbl, UI::GUILabel(ui, pnl, CSTR("Longitude")));
	...
	NEW_CLASS(lbl, UI::GUILabel(ui, pnl, CSTR("Altitude")));
	...
	NEW_CLASS(lbl, UI::GUILabel(ui, pnl, CSTR("Speed (knot)")));
	...
	NEW_CLASS(lbl, UI::GUILabel(ui, pnl, CSTR("Speed (km/h)")));
	...
	NEW_CLASS(lbl, UI::GUILabel(ui, pnl, CSTR("Heading")));
	...
	NEW_CLASS(lbl, UI::GUILabel(ui, pnl, CSTR("Valid")));
	...
	NEW_CLASS(lbl, UI::GUILabel(ui, pnl, CSTR("nSateView")));
	...
	NEW_CLASS(lbl, UI::GUILabel(ui, pnl, CSTR("nSateUsed")));
	...
	NEW_CLASS(this->lblAddress, UI::GUILabel(ui, pnl, CSTR("Address")));
