...
void SSWR::DataSync::SyncClientDataMgr::AddUserData(const UInt8 *data, UIntOS dataSize)
{
...
const UInt8 *SSWR::DataSync::SyncClientDataMgr::GetData(UIntOS index, UIntOS *dataSize)
{
	Sync::MutexUsage mutUsage(this->mut);
