...
Media::AFilter::DTMFGenerator::DTMFGenerator(NN<AudioSource> sourceAudio) : Media::AudioFilter(sourceAudio)
{
...
void Media::AFilter::DTMFGenerator::SetTone(UTF8Char tone)
{
	Double freq1;
	Double freq2;
	switch (tone)
...
void Media::AFilter::DTMFGenerator::SetVolume(Double vol)
{
	this->vol = vol;
}

Bool Media::AFilter::DTMFGenerator::GenTones(UInt32 signalTime, UInt32 breakTime, Double vol, UnsafeArray<const UTF8Char> tones)
{
