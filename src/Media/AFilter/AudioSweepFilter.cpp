...
Media::AFilter::AudioSweepFilter::AudioSweepFilter(NN<AudioSource> sourceAudio) : Media::AudioFilter(sourceAudio)
{
...
Media::AFilter::AudioSweepFilter::~AudioSweepFilter()
{
}

void Media::AFilter::AudioSweepFilter::GetFormat(NN<AudioFormat> format)
{
...
void Media::AFilter::AudioSweepFilter::SetVolume(Double vol)
{
	this->vol = vol;
}

Bool Media::AFilter::AudioSweepFilter::StartSweep(Double startFreq, Double endFreq, UInt32 timeSeconds)
{
	Sync::MutexUsage mutUsage(this->mut);
