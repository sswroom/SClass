...
void __stdcall Media::AFilter::DTMFDecoder::CalcThread(NN<Sync::Thread> thread)
{
...
void Media::AFilter::DTMFDecoder::ResetStatus()
{
...
void Media::AFilter::DTMFDecoder::HandleToneChange(ToneChangeEvent hdlr, AnyType userObj)
{
