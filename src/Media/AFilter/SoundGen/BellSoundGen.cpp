...
Media::AFilter::SoundGen::BellSoundGen::BellSoundGen(UInt32 freq) : Media::AFilter::SoundGen::SoundTypeGen(freq)
{
	this->sampleVol = 0;
	this->currSample = 0;
}

Media::AFilter::SoundGen::BellSoundGen::~BellSoundGen()
{
}
...
Media::AFilter::SoundGen::SoundTypeGen::SoundType Media::AFilter::SoundGen::BellSoundGen::GetSoundType()
{
	return Media::AFilter::SoundGen::SoundTypeGen::ST_BELL;
}

Bool Media::AFilter::SoundGen::BellSoundGen::GenSound(Double sampleVol)
{
	Sync::MutexUsage mutUsage(this->soundMut);
