...
UInt32 __stdcall Media::OpenSLESRenderer::PlayThread(void *obj)
{
	...
	NEW_CLASS(evt, Sync::Event((const UTF8Char*)"Media.OpenSLESRenderer.PlayThread.evt"));
...
Int32 Media::OpenSLESRenderer::GetCurrTime(void *hand)
{
	Int32 ret = 0;
	Int32 err;
...
Int32 Media::OpenSLESRenderer::GetDeviceCount()
{
	return 1;
}
...
void Media::OpenSLESRenderer::OnEvent()
{
	this->playEvt->Set();
}
...
void Media::OpenSLESRenderer::Start()
{
	if (playing)
		return;
	if (this->audsrc == 0)
...
Bool Media::OpenSLESRenderer::IsPlaying()
{
	return this->playing;
}
...
Int32 Media::OpenSLESRenderer::GetDeviceVolume()
{
/*	HMIXER hMxr;
	Int32 vol = -1;
...
void Media::OpenSLESRenderer::SetDeviceVolume(Int32 volume)
{
/*	HMIXER hMxr;
	if (volume > 65535)
		volume = 65535;
