...
void Media::DrawImageTool::SplitString(NotNullPtr<Media::DrawImage> dimg, Text::CStringNN txt, NotNullPtr<Data::ArrayListStringNN> outStr, NotNullPtr<Media::DrawFont> f, Double width)
{
	UOSInt i;
	UOSInt k;
	Math::Size2DDbl sz;
