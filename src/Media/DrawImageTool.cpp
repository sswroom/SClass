...
void Media::DrawImageTool::SplitString(NotNullPtr<Media::DrawImage> dimg, Text::CString txt, Data::ArrayListNN<Text::String> *outStr, Media::DrawFont *f, Double width)
{
	UOSInt i;
	UOSInt k;
	Math::Size2DDbl sz;
