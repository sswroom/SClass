...
Optional<Media::DrawImage> Media::CodeImageGen::EAN5CodeImageGen::GenCode(Text::CString code, UOSInt codeWidth, NN<Media::DrawEngine> eng)
{
	UTF8Char sbuff[2];
	if (code.v == 0)
		return 0;
	...
	if (!eng->CreateImage32(Math::Size2D<UOSInt>((4 + 48) * codeWidth, h), Media::AT_NO_ALPHA).SetTo(dimg))
		return 0;
