...
CSNV12_RGB32C_VerticalFilterLRGB:
	...
	mov rax,r9 ;width
	mov rcx,r9 ;width
	sub qword [rsp+136],r9 ;yAdd				;OSInt yAdd = ystep - width;
	shr rax,1
	shr rcx,3
	sub rax,2
...
CSNV12_RGB32C_do_yv12rgb8:
	...
	mov rdx,r9 ;width
	lea rax,[rdx*8]
	sub qword [rsp+120],rdx ;yAdd					Int32 yAdd = yBpl - width;
	shr rdx,1
	mov qword [rsp-8],rax ;cSize					Int32 cSize = width << 3;
	sub qword [rsp+128],rdx ;uvAdd					Int32 uvAdd = uvBpl - (width >> 1);
	sub rdx,2
...
CSNV12_RGB32C_do_yv12rgb2:
	...
	lea rcx,[rdx-2]
	lea rax,[rdx*8]
	sub qword [rsp+120],rcx ;yAdd					Int32 yAdd = yBpl - width - 2;
	shr rdx,1
	inc rdx
	mov qword [rsp-8],rax ;cSize					Int32 cSize = width << 3;
	sub qword [rsp+128],rdx ;uvAdd					Int32 uvAdd = uvBpl - ((width + 2) >> 1);
	sub rdx,2
	mov qword [rsp-16],rdx ;cSub						Int32 cSub = (width >> 1) - 2;
