...
extern "C"
{
	void CSAYUV_RGB8_do_ayuvrgb(UInt8 *src, UInt8 *dest, UIntOS width, UIntOS height, IntOS dbpl, Int64 *yuv2rgb, UInt8 *rgbGammaCorr);
}
...
void Media::CS::CSAYUV_RGB8::ConvertV2(UnsafeArray<const UnsafeArray<UInt8>> srcPtr, UnsafeArray<UInt8> destPtr, UIntOS dispWidth, UIntOS dispHeight, UIntOS srcStoreWidth, UIntOS srcStoreHeight, IntOS destRGBBpl, Media::FrameType ftype, Media::YCOffset ycOfst)
{
	this->UpdateTable();
...
UIntOS Media::CS::CSAYUV_RGB8::GetSrcFrameSize(UIntOS width, UIntOS height)
{
