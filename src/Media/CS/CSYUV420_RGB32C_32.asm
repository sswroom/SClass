...
CSYUV420_RGB32C_VerticalFilterLRGB
	...
	sub esp,16
	punpckldq xmm7,xmm7
	punpckldq xmm7,xmm7			;Int32 tmpV[4] = {32768, 32768, 32768, 32768};
	mov edx,dword [esp+60] ;width
	mov eax,edx
	mov ecx,edx
	sub dword [esp+96],edx			;OSInt yAdd = ystep - width;
	shr eax,1
	shr ecx,3
	sub eax,2
...
vf7lop5:
	...
	paddsw xmm5,xmm6
	pextrw eax,xmm5,0
	mov edx,dword [ebx+eax*4+1572864]
	pextrw eax,xmm5,1
	or edx,dword [ebx+eax*4+1835008]
	pextrw eax,xmm5,2
	or edx,dword [ebx+eax*4+2097152]
...
y2rllop2b:
	...
	pextrw eax,xmm2,1
	movq xmm6,[esi+eax*8+524288]
	pextrw eax,xmm2,5
	movq xmm5,[esi+eax*8+524288]
	paddsw xmm4,xmm6
	paddsw xmm1,xmm5

	pextrw eax,xmm2,0
	movq xmm6,[esi+eax*8+1048576]
	pextrw eax,xmm2,4
	movq xmm5,[esi+eax*8+1048576]
	paddsw xmm4,xmm6
	paddsw xmm1,xmm5

	pextrw eax,xmm4,0
	mov edx,dword [esi+eax*4+1572864]
	pextrw eax,xmm4,1
	or edx,dword [esi+eax*4+1835008]
	pextrw eax,xmm4,2
	or edx,dword [esi+eax*4+2097152]
	movnti dword [edi],edx
