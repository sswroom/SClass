...
CSYUV420_LRGBC_VerticalFilterLRGB
	...
	mov rax,rdx
	mov rcx,rdx
	sub qword [rsp+144],rdx ;yAdd				;OSInt yAdd = ystep - width;
	shr rax,1
	shr rcx,3
	sub rax,2
...
vf7lop5:
	...
	add r9,qword [rsp+152] ;dstep outPt
...
vflop2:
	...
	mov rcx,qword [rsp+136] ;csLineBuff2
	mov rbx,qword [rsp+160] ;yuv2rgb
	mov r12,qword [rsp+168] ;rgbGammaCorr
...
CSYUV420_LRGBC_do_yv12rgb2:
	...
	lea rcx,[rdx-2]
	lea rax,[rdx*8]
	sub qword [rsp+128],rcx ;yAdd					Int32 yAdd = yBpl - width - 2;
	shr rdx,1
	inc rdx
	mov qword [rsp-8],rax ;cSize					Int32 cSize = width << 3;
	sub qword [rsp+136],rdx ;uvAdd					Int32 uvAdd = uvBpl - ((width + 2) >> 1);
	sub rdx,2
	mov qword [rsp-16],rdx ;cSub						Int32 cSub = (width >> 1) - 2;
