...
void Media::CS::CSAYUV444_10_LRGBC::YUVParamChanged(NN<const Media::ColorHandler::YUVPARAM> yuv)
{
	MemCopyNO(&this->yuvParam, yuv.Ptr(), sizeof(YUVPARAM));
	this->yuvUpdated = true;
}

void Media::CS::CSAYUV444_10_LRGBC::RGBParamChanged(NN<const Media::ColorHandler::RGBPARAM2> rgb)
{
