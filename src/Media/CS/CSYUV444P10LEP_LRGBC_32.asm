...
;void CSYUV444P10LEP_LRGBC_convert(UInt8 *yPtr, UInt8 *uPtr, UInt8 *vPtr, UInt8 *dest, IntOS width, IntOS height, IntOS dbpl, IntOS yBpl, Int64 *yuv2rgb, Int64 *rgbGammaCorr);
; 0 edi
; 4 esi
; 8 ebx
; 12 ebp
