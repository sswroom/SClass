...
_CSYUV420_LRGBC_VerticalFilterLRGB:
	...
	mov rax,rdx
	mov rcx,rdx
	sub qword [rsp+128],rdx			;IntOS yAdd = ystep - width;
	shr rax,1
	shr rcx,3
	sub rax,2
	mov qword [rsp+24],rcx ;sWidth	IntOS sWidth = width >> 3;
	mov qword [rsp+16],rax ;cSub	IntOS cSub = (width >> 1) - 2;
	...
	jz vflstart
									; if (width & 7)
	shr rdx,2
	mov qword [rsp+96],rdx			; IntOS widthLeft = (width & 7) >> 2;
...
y2rllop2b:
	...
	add r9,qword [rsp+168] ;dstep outPt
