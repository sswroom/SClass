...
;void CSP016_LRGBC_VerticalFilterLRGB(UInt8 *inYPt, UInt8 *inUVPt, UInt8 *outPt, IntOS width, IntOS height, IntOS tap, IntOS *index, Int64 *weight, Int32 isFirst, Int32 isLast, UInt8 *csLineBuff, UInt8 *csLineBuff2, IntOS ystep, IntOS dstep, Int64 *yuv2rgb, Int64 *rgbGammaCorr)
; xmm8 tmpV
; 48 cSub
; 56 sWidth
; 64 rdi
...
CSP016_LRGBC_VerticalFilterLRGB:
	...
	mov rax,r9 ;width
	mov rcx,r9 ;width
	sub qword [rsp+200],r9 ;yAdd
	sub qword [rsp+200],r9 ;yAdd				;IntOS yAdd = ystep - (width << 1);
	shr rax,1
	shr rcx,3
	sub rax,2
...
;void CSP016_LRGBC_do_yv12rgb8(UInt8 *yPtr, UInt8 *uvPtr, UInt8 *dest, IntOS width, IntOS height, IntOS dbpl, IntOS isFirst, IntOS isLast, UInt8 *csLineBuff, UInt8 *csLineBuff2, IntOS yBpl, IntOS uvBpl, Int64 *yuv2rgb, Int64 *rgbGammaCorr)
;8 widthLeft
;16 cSub
;24 cSize
;32 rdi
...
CSP016_LRGBC_do_yv12rgb8:
	...
	lea rdx,[r9*2] ;width
	lea rax,[rdx*4]
	sub qword [rsp+152],rdx ;yAdd					Int32 yAdd = yBpl - width * 2;
	shr rdx,1
	mov qword [rsp+24],rax ;cSize					Int32 cSize = width << 3;
	sub qword [rsp+160],rdx ;uvAdd					Int32 uvAdd = uvBpl - width;
	shr rdx,1
	sub rdx,2
...
y2r8flop:
	...
	mov rsi,r10 ;yPtr
	mov rcx,r9 ;width
	mov rdi,qword [rsp+176] ;csLineBuff2
	mov rbx,qword [rsp+200] ;yuv2rgb
	shr rcx,1
	align 16
y2r8flop2:
	movzx rax,word [rsi]
...
;void CSP016_LRGBC_do_yv12rgb2(UInt8 *yPtr, UInt8 *uvPtr, UInt8 *dest, IntOS width, IntOS height, IntOS dbpl, IntOS isFirst, IntOS isLast, UInt8 *csLineBuff, UInt8 *csLineBuff2, IntOS yBpl, IntOS uvBpl, Int64 *yuv2rgb, Int64 *rgbGammaCorr)
;8 widthLeft
;16 cSub
;24 cSize
;32 rdi
...
CSP016_LRGBC_do_yv12rgb2:
	...
	lea rcx,[rdx*2-4]
	lea rax,[rdx*8]
	sub qword [rsp+152],rcx ;yAdd					Int32 yAdd = yBpl - width * 2 - 4;
	add rdx,2
	mov qword [rsp+24],rax ;cSize					Int32 cSize = width << 3;
	sub qword [rsp+160],rdx ;uvAdd					Int32 uvAdd = uvBpl - (width + 2);
	shr rdx,1
	sub rdx,3
	mov qword [rsp+16],rdx ;cSub						Int32 cSub = (width >> 1) - 2;
