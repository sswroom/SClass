...
global _CSY416_RGB32C_convert
global CSY416_RGB32C_convert

;void CSY416_RGB32C_convert(UInt8 *yPtr, UInt8 *dest, OSInt width, OSInt height, OSInt dbpl, OSInt yBpl, Int64 *yuv2rgb, Int64 *rgbGammaCorr);
; 0 edi
; 4 esi
; 8 ebx
; 12 ebp
...
; 48 rgbGammaCorr
	...
	align 16
_CSY416_RGB32C_convert:
CSY416_RGB32C_convert:
	push ebp
	push ebx
	push esi
	push edi
