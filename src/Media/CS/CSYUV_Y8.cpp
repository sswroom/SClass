...
void Media::CS::CSYUV_Y8::YUVParamChanged(NN<const Media::ColorHandler::YUVPARAM> yuvParam)
{

}

void Media::CS::CSYUV_Y8::RGBParamChanged(NN<const Media::ColorHandler::RGBPARAM2> rgbParam)
{
