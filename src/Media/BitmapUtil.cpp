...
Media::StaticImage *Media::BitmapUtil::ParseDIBBuffer(const UInt8 *dataBuff, UOSInt dataSize)
{
	...
	NEW_CLASS(outImg, Media::StaticImage(Math::Size2D<UOSInt>((UOSInt)imgWidth, (UOSInt)imgHeight), 0, bpp, Media::PixelFormatGetDef(0, bpp), 0, 0, Media::ColorProfile::YUVT_UNKNOWN, (bpp == 32)?Media::AT_ALPHA:Media::AT_NO_ALPHA, Media::YCOFST_C_CENTER_LEFT));
