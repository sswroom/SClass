...
Media::Image *Media::ImageWin::CreateImage(HBITMAP hbmp)
{
	...
	if (bmi.bmiHeader.biBitCount == 24)
	{
		...
		NEW_CLASS(img, Media::StaticImage(bmi.bmiHeader.biWidth, bmi.bmiHeader.biHeight, 0, 24, 0, Media::CS::TRANT_UNKNOWN, Media::IColorHandler::YUVT_UNKNOWN, 2.2, Media::AT_NO_ALPHA));
	...
	else if (bmi.bmiHeader.biBitCount == 32)
	{
		...
		NEW_CLASS(img, Media::StaticImage(bmi.bmiHeader.biWidth, bmi.bmiHeader.biHeight, 0, 24, 0, Media::CS::TRANT_UNKNOWN, Media::IColorHandler::YUVT_UNKNOWN, 2.2, Media::AT_ALPHA));
