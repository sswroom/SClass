...
Media::StaticImage *Media::Resizer::NearestNeighbourResizer32_32::ProcessToNewPartial(const Media::Image *srcImage, Math::Coord2DDbl srcTL, Math::Coord2DDbl srcBR)
{
