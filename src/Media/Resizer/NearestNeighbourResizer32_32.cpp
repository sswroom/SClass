...
Bool Media::Resizer::NearestNeighbourResizer32_32::Resize(NotNullPtr<const Media::StaticImage> srcImg, NotNullPtr<Media::StaticImage> destImg)
{
...
Bool Media::Resizer::NearestNeighbourResizer32_32::IsSupported(NotNullPtr<const Media::FrameInfo> srcInfo)
{
	if (srcInfo->fourcc != 0)
		return false;
...
Media::StaticImage *Media::Resizer::NearestNeighbourResizer32_32::ProcessToNewPartial(NotNullPtr<const Media::RasterImage> srcImage, Math::Coord2DDbl srcTL, Math::Coord2DDbl srcBR)
{
