...
extern "C" void LanczosResizerFunc_HorizontalFilterB8G8R8A8PA(UInt8 *inPt, UInt8 *outPt,OSInt width, OSInt height, OSInt tap, OSInt *index, Int64 *weight, OSInt sstep, OSInt dstep, UInt8 *rgbTable, OSInt swidth, UInt8 *tmpbuff)
{
	OSInt i;
	OSInt j;
	UInt8 *currIn;
...
extern "C" void LanczosResizerFunc_HorizontalFilterB8G8R8A8(UInt8 *inPt, UInt8 *outPt,OSInt width, OSInt height, OSInt tap, OSInt *index, Int64 *weight, OSInt sstep, OSInt dstep, UInt8 *rgbTable, OSInt swidth, UInt8 *tmpbuff)
{
	OSInt i;
	OSInt j;
	UInt8 *currIn;
...
extern "C" void LanczosResizerFunc_HorizontalFilterPal8(UInt8 *inPt, UInt8 *outPt,OSInt width, OSInt height, OSInt tap, OSInt *index, Int64 *weight, OSInt sstep, OSInt dstep, UInt8 *rgbTable, OSInt swidth, UInt8 *tmpbuff)
{
	OSInt i;
	OSInt j;
	UInt8 *currIn;
...
extern "C" void LanczosResizerFunc_VerticalFilterB8G8R8A8(UInt8 *inPt, UInt8 *outPt, OSInt width, OSInt height, OSInt tap, OSInt *index, Int64 *weight, OSInt sstep, OSInt dstep, UInt8 *rgbTable)
{
	OSInt i;
	OSInt j;
	UInt8 *currIn;
...
extern "C" void LanczosResizerFunc_ExpandB8G8R8A8PA(UInt8 *inPt, UInt8 *outPt, OSInt width, OSInt height, OSInt sstep, OSInt dstep, UInt8 *rgbTable)
{
	OSInt i;
	Int16x4 cvals;
	sstep -= width << 2;
...
extern "C" void LanczosResizerFunc_ExpandB8G8R8A8(UInt8 *inPt, UInt8 *outPt, OSInt width, OSInt height, OSInt sstep, OSInt dstep, UInt8 *rgbTable)
{
	OSInt i;
	Int16x4 cvals;
	sstep -= width << 2;
...
extern "C" void LanczosResizerFunc_ExpandPal8(UInt8 *inPt, UInt8 *outPt, OSInt width, OSInt height, OSInt sstep, OSInt dstep, UInt8 *rgbTable)
{
	OSInt i;
	Int16x4 cvals;
	sstep -= width;
...
extern "C" void LanczosResizerFunc_CollapseB8G8R8A8(UInt8 *inPt, UInt8 *outPt, OSInt width, OSInt height, OSInt sstep, OSInt dstep, UInt8 *rgbTable)
{
	OSInt i;
	sstep -= width << 3;
	dstep -= width << 2;
...
extern "C" void LanczosResizerFunc_ImgCopyB8G8R8A8(UInt8 *inPt, UInt8 *outPt, OSInt width, OSInt height, OSInt sstep, OSInt dstep, UInt8 *rgbTable)
{
	OSInt i;
	Int16x4 cvals;
	UInt16x4 cvals2;
...
extern "C" void LanczosResizerFunc_ImgCopyB8G8R8A8PA(UInt8 *inPt, UInt8 *outPt, OSInt width, OSInt height, OSInt sstep, OSInt dstep, UInt8 *rgbTable)
{
	OSInt i;
	Int16x4 cvals;
	UInt16x4 cvals2;
...
extern "C" void LanczosResizerFunc_ImgCopyPal8(UInt8 *inPt, UInt8 *outPt, OSInt width, OSInt height, OSInt sstep, OSInt dstep, UInt8 *rgbTable)
{
	OSInt i;
	Int16x4 cvals;
	UInt16x4 cvals2;
