...
Media::VideoFilter::IVTCFilter::IVTCFilter(Media::IVideoSource *srcVideo) : Media::VideoFilter::VideoFilterBase(srcVideo)
{
	...
	this->ivtcLastFieldUsed = false;
#ifdef _DEBUG
	NEW_CLASS(this->debugFS, IO::FileStream((const UTF8Char*)"IVTC.log", IO::FileStream::FileMode::Append, IO::FileStream::FileShare::DenyNone, IO::FileStream::BufferType::Normal));
