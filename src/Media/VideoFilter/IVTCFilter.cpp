...
Media::VideoFilter::IVTCFilter::IVTCFilter(Media::IVideoSource *srcVideo) : Media::VideoFilter::VideoFilterBase(srcVideo)
{
	...
	this->ivtcLastFieldUsed = false;
#ifdef _DEBUG
	NEW_CLASS(this->debugFS, IO::FileStream((const UTF8Char*)"IVTC.log", IO::FileStream::FILE_MODE_APPEND, IO::FileStream::FILE_SHARE_DENY_NONE, IO::FileStream::BT_NORMAL));
