...
Media::AACFrameSource::AACFrameSource(NN<IO::StreamData> fd, NN<const Media::AudioFormat> format, NN<Text::String> name) : Media::AudioFrameSource(fd, format, name)
{
}

Media::AACFrameSource::AACFrameSource(NN<IO::StreamData> fd, NN<const Media::AudioFormat> format, Text::CStringNN name) : Media::AudioFrameSource(fd, format, name)
{
}
